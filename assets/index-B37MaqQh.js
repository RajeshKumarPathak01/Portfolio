 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Yg;function Yx(){if(Yg)return re;Yg=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function x(U){return U===null||typeof U!="object"?null:(U=v&&U[v]||U["@@iterator"],typeof U=="function"?U:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},A=Object.assign,C={};function y(U,J,vt){this.props=U,this.context=J,this.refs=C,this.updater=vt||M}y.prototype.isReactComponent={},y.prototype.setState=function(U,J){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,J,"setState")},y.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function _(){}_.prototype=y.prototype;function B(U,J,vt){this.props=U,this.context=J,this.refs=C,this.updater=vt||M}var N=B.prototype=new _;N.constructor=B,A(N,y.prototype),N.isPureReactComponent=!0;var w=Array.isArray,V={H:null,A:null,T:null,S:null,V:null},I=Object.prototype.hasOwnProperty;function H(U,J,vt,St,K,pt){return vt=pt.ref,{$$typeof:s,type:U,key:J,ref:vt!==void 0?vt:null,props:pt}}function j(U,J){return H(U.type,J,void 0,void 0,void 0,U.props)}function D(U){return typeof U=="object"&&U!==null&&U.$$typeof===s}function R(U){var J={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(vt){return J[vt]})}var k=/\/+/g;function lt(U,J){return typeof U=="object"&&U!==null&&U.key!=null?R(""+U.key):J.toString(36)}function st(){}function ut(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(st,st):(U.status="pending",U.then(function(J){U.status==="pending"&&(U.status="fulfilled",U.value=J)},function(J){U.status==="pending"&&(U.status="rejected",U.reason=J)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function _t(U,J,vt,St,K){var pt=typeof U;(pt==="undefined"||pt==="boolean")&&(U=null);var yt=!1;if(U===null)yt=!0;else switch(pt){case"bigint":case"string":case"number":yt=!0;break;case"object":switch(U.$$typeof){case s:case e:yt=!0;break;case g:return yt=U._init,_t(yt(U._payload),J,vt,St,K)}}if(yt)return K=K(U),yt=St===""?"."+lt(U,0):St,w(K)?(vt="",yt!=null&&(vt=yt.replace(k,"$&/")+"/"),_t(K,J,vt,"",function(oe){return oe})):K!=null&&(D(K)&&(K=j(K,vt+(K.key==null||U&&U.key===K.key?"":(""+K.key).replace(k,"$&/")+"/")+yt)),J.push(K)),1;yt=0;var Rt=St===""?".":St+":";if(w(U))for(var wt=0;wt<U.length;wt++)St=U[wt],pt=Rt+lt(St,wt),yt+=_t(St,J,vt,pt,K);else if(wt=x(U),typeof wt=="function")for(U=wt.call(U),wt=0;!(St=U.next()).done;)St=St.value,pt=Rt+lt(St,wt++),yt+=_t(St,J,vt,pt,K);else if(pt==="object"){if(typeof U.then=="function")return _t(ut(U),J,vt,St,K);throw J=String(U),Error("Objects are not valid as a React child (found: "+(J==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":J)+"). If you meant to render a collection of children, use an array instead.")}return yt}function O(U,J,vt){if(U==null)return U;var St=[],K=0;return _t(U,St,"","",function(pt){return J.call(vt,pt,K++)}),St}function $(U){if(U._status===-1){var J=U._result;J=J(),J.then(function(vt){(U._status===0||U._status===-1)&&(U._status=1,U._result=vt)},function(vt){(U._status===0||U._status===-1)&&(U._status=2,U._result=vt)}),U._status===-1&&(U._status=0,U._result=J)}if(U._status===1)return U._result.default;throw U._result}var q=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var J=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent(J))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)};function Mt(){}return re.Children={map:O,forEach:function(U,J,vt){O(U,function(){J.apply(this,arguments)},vt)},count:function(U){var J=0;return O(U,function(){J++}),J},toArray:function(U){return O(U,function(J){return J})||[]},only:function(U){if(!D(U))throw Error("React.Children.only expected to receive a single React element child.");return U}},re.Component=y,re.Fragment=i,re.Profiler=l,re.PureComponent=B,re.StrictMode=r,re.Suspense=p,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=V,re.__COMPILER_RUNTIME={__proto__:null,c:function(U){return V.H.useMemoCache(U)}},re.cache=function(U){return function(){return U.apply(null,arguments)}},re.cloneElement=function(U,J,vt){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var St=A({},U.props),K=U.key,pt=void 0;if(J!=null)for(yt in J.ref!==void 0&&(pt=void 0),J.key!==void 0&&(K=""+J.key),J)!I.call(J,yt)||yt==="key"||yt==="__self"||yt==="__source"||yt==="ref"&&J.ref===void 0||(St[yt]=J[yt]);var yt=arguments.length-2;if(yt===1)St.children=vt;else if(1<yt){for(var Rt=Array(yt),wt=0;wt<yt;wt++)Rt[wt]=arguments[wt+2];St.children=Rt}return H(U.type,K,void 0,void 0,pt,St)},re.createContext=function(U){return U={$$typeof:h,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:u,_context:U},U},re.createElement=function(U,J,vt){var St,K={},pt=null;if(J!=null)for(St in J.key!==void 0&&(pt=""+J.key),J)I.call(J,St)&&St!=="key"&&St!=="__self"&&St!=="__source"&&(K[St]=J[St]);var yt=arguments.length-2;if(yt===1)K.children=vt;else if(1<yt){for(var Rt=Array(yt),wt=0;wt<yt;wt++)Rt[wt]=arguments[wt+2];K.children=Rt}if(U&&U.defaultProps)for(St in yt=U.defaultProps,yt)K[St]===void 0&&(K[St]=yt[St]);return H(U,pt,void 0,void 0,null,K)},re.createRef=function(){return{current:null}},re.forwardRef=function(U){return{$$typeof:d,render:U}},re.isValidElement=D,re.lazy=function(U){return{$$typeof:g,_payload:{_status:-1,_result:U},_init:$}},re.memo=function(U,J){return{$$typeof:m,type:U,compare:J===void 0?null:J}},re.startTransition=function(U){var J=V.T,vt={};V.T=vt;try{var St=U(),K=V.S;K!==null&&K(vt,St),typeof St=="object"&&St!==null&&typeof St.then=="function"&&St.then(Mt,q)}catch(pt){q(pt)}finally{V.T=J}},re.unstable_useCacheRefresh=function(){return V.H.useCacheRefresh()},re.use=function(U){return V.H.use(U)},re.useActionState=function(U,J,vt){return V.H.useActionState(U,J,vt)},re.useCallback=function(U,J){return V.H.useCallback(U,J)},re.useContext=function(U){return V.H.useContext(U)},re.useDebugValue=function(){},re.useDeferredValue=function(U,J){return V.H.useDeferredValue(U,J)},re.useEffect=function(U,J,vt){var St=V.H;if(typeof vt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return St.useEffect(U,J)},re.useId=function(){return V.H.useId()},re.useImperativeHandle=function(U,J,vt){return V.H.useImperativeHandle(U,J,vt)},re.useInsertionEffect=function(U,J){return V.H.useInsertionEffect(U,J)},re.useLayoutEffect=function(U,J){return V.H.useLayoutEffect(U,J)},re.useMemo=function(U,J){return V.H.useMemo(U,J)},re.useOptimistic=function(U,J){return V.H.useOptimistic(U,J)},re.useReducer=function(U,J,vt){return V.H.useReducer(U,J,vt)},re.useRef=function(U){return V.H.useRef(U)},re.useState=function(U){return V.H.useState(U)},re.useSyncExternalStore=function(U,J,vt){return V.H.useSyncExternalStore(U,J,vt)},re.useTransition=function(){return V.H.useTransition()},re.version="19.1.0",re}var jg;function sd(){return jg||(jg=1,Pf.exports=Yx()),Pf.exports}var qe=sd(),Bf={exports:{}},yo={},zf={exports:{}},If={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zg;function jx(){return Zg||(Zg=1,function(s){function e(O,$){var q=O.length;O.push($);t:for(;0<q;){var Mt=q-1>>>1,U=O[Mt];if(0<l(U,$))O[Mt]=$,O[q]=U,q=Mt;else break t}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var $=O[0],q=O.pop();if(q!==$){O[0]=q;t:for(var Mt=0,U=O.length,J=U>>>1;Mt<J;){var vt=2*(Mt+1)-1,St=O[vt],K=vt+1,pt=O[K];if(0>l(St,q))K<U&&0>l(pt,St)?(O[Mt]=pt,O[K]=q,Mt=K):(O[Mt]=St,O[vt]=q,Mt=vt);else if(K<U&&0>l(pt,q))O[Mt]=pt,O[K]=q,Mt=K;else break t}}return $}function l(O,$){var q=O.sortIndex-$.sortIndex;return q!==0?q:O.id-$.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;s.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();s.unstable_now=function(){return h.now()-d}}var p=[],m=[],g=1,v=null,x=3,M=!1,A=!1,C=!1,y=!1,_=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;function w(O){for(var $=i(m);$!==null;){if($.callback===null)r(m);else if($.startTime<=O)r(m),$.sortIndex=$.expirationTime,e(p,$);else break;$=i(m)}}function V(O){if(C=!1,w(O),!A)if(i(p)!==null)A=!0,I||(I=!0,lt());else{var $=i(m);$!==null&&_t(V,$.startTime-O)}}var I=!1,H=-1,j=5,D=-1;function R(){return y?!0:!(s.unstable_now()-D<j)}function k(){if(y=!1,I){var O=s.unstable_now();D=O;var $=!0;try{t:{A=!1,C&&(C=!1,B(H),H=-1),M=!0;var q=x;try{e:{for(w(O),v=i(p);v!==null&&!(v.expirationTime>O&&R());){var Mt=v.callback;if(typeof Mt=="function"){v.callback=null,x=v.priorityLevel;var U=Mt(v.expirationTime<=O);if(O=s.unstable_now(),typeof U=="function"){v.callback=U,w(O),$=!0;break e}v===i(p)&&r(p),w(O)}else r(p);v=i(p)}if(v!==null)$=!0;else{var J=i(m);J!==null&&_t(V,J.startTime-O),$=!1}}break t}finally{v=null,x=q,M=!1}$=void 0}}finally{$?lt():I=!1}}}var lt;if(typeof N=="function")lt=function(){N(k)};else if(typeof MessageChannel<"u"){var st=new MessageChannel,ut=st.port2;st.port1.onmessage=k,lt=function(){ut.postMessage(null)}}else lt=function(){_(k,0)};function _t(O,$){H=_(function(){O(s.unstable_now())},$)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(O){O.callback=null},s.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<O?Math.floor(1e3/O):5},s.unstable_getCurrentPriorityLevel=function(){return x},s.unstable_next=function(O){switch(x){case 1:case 2:case 3:var $=3;break;default:$=x}var q=x;x=$;try{return O()}finally{x=q}},s.unstable_requestPaint=function(){y=!0},s.unstable_runWithPriority=function(O,$){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var q=x;x=O;try{return $()}finally{x=q}},s.unstable_scheduleCallback=function(O,$,q){var Mt=s.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?Mt+q:Mt):q=Mt,O){case 1:var U=-1;break;case 2:U=250;break;case 5:U=1073741823;break;case 4:U=1e4;break;default:U=5e3}return U=q+U,O={id:g++,callback:$,priorityLevel:O,startTime:q,expirationTime:U,sortIndex:-1},q>Mt?(O.sortIndex=q,e(m,O),i(p)===null&&O===i(m)&&(C?(B(H),H=-1):C=!0,_t(V,q-Mt))):(O.sortIndex=U,e(p,O),A||M||(A=!0,I||(I=!0,lt()))),O},s.unstable_shouldYield=R,s.unstable_wrapCallback=function(O){var $=x;return function(){var q=x;x=$;try{return O.apply(this,arguments)}finally{x=q}}}}(If)),If}var Kg;function Zx(){return Kg||(Kg=1,zf.exports=jx()),zf.exports}var Ff={exports:{}},Cn={};/**
 * @license React
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,le={alphahash_fragment:eM,alphahash_pars_fragment:nM,alphamap_fragment:iM,alphamap_pars_fragment:aM,alphatest_fragment:rM,alphatest_pars_fragment:sM,aomap_fragment:oM,aomap_pars_fragment:lM,batching_pars_vertex:cM,batching_vertex:uM,begin_vertex:fM,beginnormal_vertex:hM,bsdfs:dM,iridescence_fragment:pM,bumpmap_pars_fragment:mM,clipping_planes_fragment:gM,clipping_planes_pars_fragment:_M,clipping_planes_pars_vertex:vM,clipping_planes_vertex:xM,color_fragment:SM,color_pars_fragment:yM,color_pars_vertex:MM,color_vertex:EM,common:TM,cube_uv_reflection_fragment:bM,defaultnormal_vertex:AM,displacementmap_pars_vertex:RM,displacementmap_vertex:CM,emissivemap_fragment:wM,emissivemap_pars_fragment:DM,colorspace_fragment:UM,colorspace_pars_fragment:LM,envmap_fragment:NM,envmap_common_pars_fragment:OM,envmap_pars_fragment:PM,envmap_pars_vertex:BM,envmap_physical_pars_fragment:YM,envmap_vertex:zM,fog_vertex:IM,fog_pars_vertex:FM,fog_fragment:HM,fog_pars_fragment:GM,gradientmap_pars_fragment:VM,lightmap_pars_fragment:kM,lights_lambert_fragment:XM,lights_lambert_pars_fragment:WM,lights_pars_begin:qM,lights_toon_fragment:jM,lights_toon_pars_fragment:ZM,lights_phong_fragment:KM,lights_phong_pars_fragment:QM,lights_physical_fragment:JM,lights_physical_pars_fragment:$M,lights_fragment_begin:tE,lights_fragment_maps:eE,lights_fragment_end:nE,logdepthbuf_fragment:iE,logdepthbuf_pars_fragment:aE,logdepthbuf_pars_vertex:rE,logdepthbuf_vertex:sE,map_fragment:oE,map_pars_fragment:lE,map_particle_fragment:cE,map_particle_pars_fragment:uE,metalnessmap_fragment:fE,metalnessmap_pars_fragment:hE,morphinstance_vertex:dE,morphcolor_vertex:pE,morphnormal_vertex:mE,morphtarget_pars_vertex:gE,morphtarget_vertex:_E,normal_fragment_begin:vE,normal_fragment_maps:xE,normal_pars_fragment:SE,normal_pars_vertex:yE,normal_vertex:ME,normalmap_pars_fragment:EE,clearcoat_normal_fragment_begin:TE,clearcoat_normal_fragment_maps:bE,clearcoat_pars_fragment:AE,iridescence_pars_fragment:RE,opaque_fragment:CE,packing:wE,premultiplied_alpha_fragment:DE,project_vertex:UE,dithering_fragment:LE,dithering_pars_fragment:NE,roughnessmap_fragment:OE,roughnessmap_pars_fragment:PE,shadowmap_pars_fragment:BE,shadowmap_pars_vertex:zE,shadowmap_vertex:IE,shadowmask_pars_fragment:FE,skinbase_vertex:HE,skinning_pars_vertex:GE,skinning_vertex:VE,skinnormal_vertex:kE,specularmap_fragment:XE,specularmap_pars_fragment:WE,tonemapping_fragment:qE,tonemapping_pars_fragment:YE,transmission_fragment:jE,transmission_pars_fragment:ZE,uv_pars_fragment:KE,uv_pars_vertex:QE,uv_vertex:JE,worldpos_vertex:$E,background_vert:tT,background_frag:eT,backgroundCube_vert:nT,backgroundCube_frag:iT,cube_vert:aT,cube_frag:rT,depth_vert:sT,depth_frag:oT,distanceRGBA_vert:lT,distanceRGBA_frag:cT,equirect_vert:uT,equirect_frag:fT,linedashed_vert:hT,linedashed_frag:dT,meshbasic_vert:pT,meshbasic_frag:mT,meshlambert_vert:gT,meshlambert_frag:_T,meshmatcap_vert:vT,meshmatcap_frag:xT,meshnormal_vert:ST,meshnormal_frag:yT,meshphong_vert:MT,meshphong_frag:ET,meshphysical_vert:TT,meshphysical_frag:bT,meshtoon_vert:AT,meshtoon_frag:RT,points_vert:CT,points_frag:wT,shadow_vert:DT,shadow_frag:UT,sprite_vert:LT,sprite_frag:NT},Nt={common:{diffuse:{value:new Be(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new se},alphaMap:{value:null},alphaMapTransform:{value:new se},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new se}},envmap:{envMap:{value:null},envMapRotation:{value:new se},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new se}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new se}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new se},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new se},normalScale:{value:new He(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new se},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new se}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new se}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new se}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new Be(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new Be(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new se},alphaTest:{value:0},uvTransform:{value:new se}},sprite:{diffuse:{value:new Be(16777215)},opacity:{value:1},center:{value:new He(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new se},alphaMap:{value:null},alphaMapTransform:{value:new se},alphaTest:{value:0}}},Ti={basic:{uniforms:Ln([Nt.common,Nt.specularmap,Nt.envmap,Nt.aomap,Nt.lightmap,Nt.fog]),vertexShader:le.meshbasic_vert,fragmentShader:le.meshbasic_frag},lambert:{uniforms:Ln([Nt.common,Nt.specularmap,Nt.envmap,Nt.aomap,Nt.lightmap,Nt.emissivemap,Nt.bumpmap,Nt.normalmap,Nt.displacementmap,Nt.fog,Nt.lights,{emissive:{value:new Be(0)}}]),vertexShader:le.meshlambert_vert,fragmentShader:le.meshlambert_frag},phong:{uniforms:Ln([Nt.common,Nt.specularmap,Nt.envmap,Nt.aomap,Nt.lightmap,Nt.emissivemap,Nt.bumpmap,Nt.normalmap,Nt.displacementmap,Nt.fog,Nt.lights,{emissive:{value:new Be(0)},specular:{value:new Be(1118481)},shininess:{value:30}}]),vertexShader:le.meshphong_vert,fragmentShader:le.meshphong_frag},standard:{uniforms:Ln([Nt.common,Nt.envmap,Nt.aomap,Nt.lightmap,Nt.emissivemap,Nt.bumpmap,Nt.normalmap,Nt.displacementmap,Nt.roughnessmap,Nt.metalnessmap,Nt.fog,Nt.lights,{emissive:{value:new Be(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:le.meshphysical_vert,fragmentShader:le.meshphysical_frag},toon:{uniforms:Ln([Nt.common,Nt.aomap,Nt.lightmap,Nt.emissivemap,Nt.bumpmap,Nt.normalmap,Nt.displacementmap,Nt.gradientmap,Nt.fog,Nt.lights,{emissive:{value:new Be(0)}}]),vertexShader:le.meshtoon_vert,fragmentShader:le.meshtoon_frag},matcap:{uniforms:Ln([Nt.common,Nt.bumpmap,Nt.normalmap,Nt.displacementmap,Nt.fog,{matcap:{value:null}}]),vertexShader:le.meshmatcap_vert,fragmentShader:le.meshmatcap_frag},points:{uniforms:Ln([Nt.points,Nt.fog]),vertexShader:le.points_vert,fragmentShader:le.points_frag},dashed:{uniforms:Ln([Nt.common,Nt.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:le.linedashed_vert,fragmentShader:le.linedashed_frag},depth:{uniforms:Ln([Nt.common,Nt.displacementmap]),vertexShader:le.depth_vert,fragmentShader:le.depth_frag},normal:{uniforms:Ln([Nt.common,Nt.bumpmap,Nt.normalmap,Nt.displacementmap,{opacity:{value:1}}]),vertexShader:le.meshnormal_vert,fragmentShader:le.meshnormal_frag},sprite:{uniforms:Ln([Nt.sprite,Nt.fog]),vertexShader:le.sprite_vert,fragmentShader:le.sprite_frag},background:{uniforms:{uvTransform:{value:new se},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:le.background_vert,fragmentShader:le.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new se}},vertexShader:le.backgroundCube_vert,fragmentShader:le.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:le.cube_vert,fragmentShader:le.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:le.equirect_vert,fragmentShader:le.equirect_frag},distanceRGBA:{uniforms:Ln([Nt.common,Nt.displacementmap,{referencePosition:{value:new rt},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:le.distanceRGBA_vert,fragmentShader:le.distanceRGBA_frag},shadow:{uniforms:Ln([Nt.lights,Nt.fog,{color:{value:new Be(0)},opacity:{value:1}}]),vertexShader:le.shadow_vert,fragmentShader:le.shadow_frag}};Ti.physical={uniforms:Ln([Ti.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new se},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new se},clearcoatNormalScale:{value:new He(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new se},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new se},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new se},sheen:{value:0},sheenColor:{value:new Be(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new se},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new se},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new se},transmissionSamplerSize:{value:new He},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new se},attenuationDistance:{value:0},attenuationColor:{value:new Be(0)},specularColor:{value:new Be(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new se},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new se},anisotropyVector:{value:new He},anisotropyMap:{value:null},anisotropyMapTransform:{value:new se}}]),vertexShader:le.meshphysical_vert,fragmentShader:le.meshphysical_frag};const dc={r:0,b:0,g:0},fr=new aa,OT=new rn;function PT(s,e,i,r,l,u,h){const d=new Be(0);let p=u===!0?0:1,m,g,v=null,x=0,M=null;function A(N){let w=N.isScene===!0?N.background:null;return w&&w.isTexture&&(w=(N.backgroundBlurriness>0?i:e).get(w)),w}function C(N){let w=!1;const V=A(N);V===null?_(d,p):V&&V.isColor&&(_(V,1),w=!0);const I=s.xr.getEnvironmentBlendMode();I==="additive"?r.buffers.color.setClear(0,0,0,1,h):I==="alpha-blend"&&r.buffers.color.setClear(0,0,0,0,h),(s.autoClear||w)&&(r.buffers.depth.setTest(!0),r.buffers.depth.setMask(!0),r.buffers.color.setMask(!0),s.clear(s.autoClearColor,s.autoClearDepth,s.autoClearStencil))}function y(N,w){const V=A(w);V&&(V.isCubeTexture||V.mapping===Cc)?(g===void 0&&(g=new Ai(new bs(1,1,1),new Ga({name:"BackgroundCubeMaterial",uniforms:Es(Ti.backgroundCube.uniforms),vertexShader:Ti.backgroundCube.vertexShader,fragmentShader:Ti.backgroundCube.fragmentShader,side:Fn,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),g.geometry.deleteAttribute("normal"),g.geometry.deleteAttribute("uv"),g.onBeforeRender=function(I,H,j){this.matrixWorld.copyPosition(j.matrixWorld)},Object.defineProperty(g.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),l.update(g)),fr.copy(w.backgroundRotation),fr.x*=-1,fr.y*=-1,fr.z*=-1,V.isCubeTexture&&V.isRenderTargetTexture===!1&&(fr.y*=-1,fr.z*=-1),g.material.uniforms.envMap.value=V,g.material.uniforms.flipEnvMap.value=V.isCubeTexture&&V.isRenderTargetTexture===!1?-1:1,g.material.uniforms.backgroundBlurriness.value=w.backgroundBlurriness,g.material.uniforms.backgroundIntensity.value=w.backgroundIntensity,g.material.uniforms.backgroundRotation.value.setFromMatrix4(OT.makeRotationFromEuler(fr)),g.material.toneMapped=be.getTransfer(V.colorSpace)!==Pe,(v!==V||x!==V.version||M!==s.toneMapping)&&(g.material.needsUpdate=!0,v=V,x=V.version,M=s.toneMapping),g.layers.enableAll(),N.unshift(g,g.geometry,g.material,0,0,null)):V&&V.isTexture&&(m===void 0&&(m=new Ai(new Dc(2,2),new Ga({name:"BackgroundMaterial",uniforms:Es(Ti.background.uniforms),vertexShader:Ti.background.vertexShader,fragmentShader:Ti.background.fragmentShader,side:Ha,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),m.geometry.deleteAttribute("normal"),Object.defineProperty(m.material,"map",{get:function(){return this.uniforms.t2D.value}}),l.update(m)),m.material.uniforms.t2D.value=V,m.material.uniforms.backgroundIntensity.value=w.backgroundIntensity,m.material.toneMapped=be.getTransfer(V.colorSpace)!==Pe,V.matrixAutoUpdate===!0&&V.updateMatrix(),m.material.uniforms.uvTransform.value.copy(V.matrix),(v!==V||x!==V.version||M!==s.toneMapping)&&(m.material.needsUpdate=!0,v=V,x=V.version,M=s.toneMapping),m.layers.enableAll(),N.unshift(m,m.geometry,m.material,0,0,null))}function _(N,w){N.getRGB(dc,U0(s)),r.buffers.color.setClear(dc.r,dc.g,dc.b,w,h)}function B(){g!==void 0&&(g.geometry.dispose(),g.material.dispose(),g=void 0),m!==void 0&&(m.geometry.dispose(),m.material.dispose(),m=void 0)}return{getClearColor:function(){return d},setClearColor:function(N,w=1){d.set(N),p=w,_(d,p)},getClearAlpha:function(){return p},setClearAlpha:function(N){p=N,_(d,p)},render:C,addToRenderList:y,dispose:B}}function BT(s,e){const i=s.getParameter(s.MAX_VERTEX_ATTRIBS),r={},l=x(null);let u=l,h=!1;function d(R,k,lt,st,ut){let _t=!1;const O=v(st,lt,k);u!==O&&(u=O,m(u.object)),_t=M(R,st,lt,ut),_t&&A(R,st,lt,ut),ut!==null&&e.update(ut,s.ELEMENT_ARRAY_BUFFER),(_t||h)&&(h=!1,w(R,k,lt,st),ut!==null&&s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,e.get(ut).buffer))}function p(){return s.createVertexArray()}function m(R){return s.bindVertexArray(R)}function g(R){return s.deleteVertexArray(R)}function v(R,k,lt){const st=lt.wireframe===!0;let ut=r[R.id];ut===void 0&&(ut={},r[R.id]=ut);let _t=ut[k.id];_t===void 0&&(_t={},ut[k.id]=_t);let O=_t[st];return O===void 0&&(O=x(p()),_t[st]=O),O}function x(R){const k=[],lt=[],st=[];for(let ut=0;ut<i;ut++)k[ut]=0,lt[ut]=0,st[ut]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:k,enabledAttributes:lt,attributeDivisors:st,object:R,attributes:{},index:null}}function M(R,k,lt,st){const ut=u.attributes,_t=k.attributes;let O=0;const $=lt.getAttributes();for(const q in $)if($[q].location>=0){const U=ut[q];let J=_t[q];if(J===void 0&&(q==="instanceMatrix"&&R.instanceMatrix&&(J=R.instanceMatrix),q==="instanceColor"&&R.instanceColor&&(J=R.instanceColor)),U===void 0||U.attribute!==J||J&&U.data!==J.data)return!0;O++}return u.attributesNum!==O||u.index!==st}function A(R,k,lt,st){const ut={},_t=k.attributes;let O=0;const $=lt.getAttributes();for(const q in $)if($[q].location>=0){let U=_t[q];U===void 0&&(q==="instanceMatrix"&&R.instanceMatrix&&(U=R.instanceMatrix),q==="instanceColor"&&R.instanceColor&&(U=R.instanceColor));const J={};J.attribute=U,U&&U.data&&(J.data=U.data),ut[q]=J,O++}u.attributes=ut,u.attributesNum=O,u.index=st}function C(){const R=u.newAttributes;for(let k=0,lt=R.length;k<lt;k++)R[k]=0}function y(R){_(R,0)}function _(R,k){const lt=u.newAttributes,st=u.enabledAttributes,ut=u.attributeDivisors;lt[R]=1,st[R]===0&&(s.enableVertexAttribArray(R),st[R]=1),ut[R]!==k&&(s.vertexAttribDivisor(R,k),ut[R]=k)}function B(){const R=u.newAttributes,k=u.enabledAttributes;for(let lt=0,st=k.length;lt<st;lt++)k[lt]!==R[lt]&&(s.disableVertexAttribArray(lt),k[lt]=0)}function N(R,k,lt,st,ut,_t,O){O===!0?s.vertexAttribIPointer(R,k,lt,ut,_t):s.vertexAttribPointer(R,k,lt,st,ut,_t)}function w(R,k,lt,st){C();const ut=st.attributes,_t=lt.getAttributes(),O=k.defaultAttributeValues;for(const $ in _t){const q=_t[$];if(q.location>=0){let Mt=ut[$];if(Mt===void 0&&($==="instanceMatrix"&&R.instanceMatrix&&(Mt=R.instanceMatrix),$==="instanceColor"&&R.instanceColor&&(Mt=R.instanceColor)),Mt!==void 0){const U=Mt.normalized,J=Mt.itemSize,vt=e.get(Mt);if(vt===void 0)continue;const St=vt.buffer,K=vt.type,pt=vt.bytesPerElement,yt=K===s.INT||K===s.UNSIGNED_INT||Mt.gpuType===cd;if(Mt.isInterleavedBufferAttribute){const Rt=Mt.data,wt=Rt.stride,oe=Mt.offset;if(Rt.isInstancedInterleavedBuffer){for(let Qt=0;Qt<q.locationSize;Qt++)_(q.location+Qt,Rt.meshPerAttribute);R.isInstancedMesh!==!0&&st._maxInstanceCount===void 0&&(st._maxInstanceCount=Rt.meshPerAttribute*Rt.count)}else for(let Qt=0;Qt<q.locationSize;Qt++)y(q.location+Qt);s.bindBuffer(s.ARRAY_BUFFER,St);for(let Qt=0;Qt<q.locationSize;Qt++)N(q.location+Qt,J/q.locationSize,K,U,wt*pt,(oe+J/q.locationSize*Qt)*pt,yt)}else{if(Mt.isInstancedBufferAttribute){for(let Rt=0;Rt<q.locationSize;Rt++)_(q.location+Rt,Mt.meshPerAttribute);R.isInstancedMesh!==!0&&st._maxInstanceCount===void 0&&(st._maxInstanceCount=Mt.meshPerAttribute*Mt.count)}else for(let Rt=0;Rt<q.locationSize;Rt++)y(q.location+Rt);s.bindBuffer(s.ARRAY_BUFFER,St);for(let Rt=0;Rt<q.locationSize;Rt++)N(q.location+Rt,J/q.locationSize,K,U,J*pt,J/q.locationSize*Rt*pt,yt)}}else if(O!==void 0){const U=O[$];if(U!==void 0)switch(U.length){case 2:s.vertexAttrib2fv(q.location,U);break;case 3:s.vertexAttrib3fv(q.location,U);break;case 4:s.vertexAttrib4fv(q.location,U);break;default:s.vertexAttrib1fv(q.location,U)}}}}B()}function V(){j();for(const R in r){const k=r[R];for(const lt in k){const st=k[lt];for(const ut in st)g(st[ut].object),delete st[ut];delete k[lt]}delete r[R]}}function I(R){if(r[R.id]===void 0)return;const k=r[R.id];for(const lt in k){const st=k[lt];for(const ut in st)g(st[ut].object),delete st[ut];delete k[lt]}delete r[R.id]}function H(R){for(const k in r){const lt=r[k];if(lt[R.id]===void 0)continue;const st=lt[R.id];for(const ut in st)g(st[ut].object),delete st[ut];delete lt[R.id]}}function j(){D(),h=!0,u!==l&&(u=l,m(u.object))}function D(){l.geometry=null,l.program=null,l.wireframe=!1}return{setup:d,reset:j,resetDefaultState:D,dispose:V,releaseStatesOfGeometry:I,releaseStatesOfProgram:H,initAttributes:C,enableAttribute:y,disableUnusedAttributes:B}}function zT(s,e,i){let r;function l(m){r=m}function u(m,g){s.drawArrays(r,m,g),i.update(g,r,1)}function h(m,g,v){v!==0&&(s.drawArraysInstanced(r,m,g,v),i.update(g,r,v))}function d(m,g,v){if(v===0)return;e.get("WEBGL_multi_draw").multiDrawArraysWEBGL(r,m,0,g,0,v);let M=0;for(let A=0;A<v;A++)M+=g[A];i.update(M,r,1)}function p(m,g,v,x){if(v===0)return;const M=e.get("WEBGL_multi_draw");if(M===null)for(let A=0;A<m.length;A++)h(m[A],g[A],x[A]);else{M.multiDrawArraysInstancedWEBGL(r,m,0,g,0,x,0,v);let A=0;for(let C=0;C<v;C++)A+=g[C]*x[C];i.update(A,r,1)}}this.setMode=l,this.render=u,this.renderInstances=h,this.renderMultiDraw=d,this.renderMultiDrawInstances=p}function IT(s,e,i,r){let l;function u(){if(l!==void 0)return l;if(e.has("EXT_texture_filter_anisotropic")===!0){const H=e.get("EXT_texture_filter_anisotropic");l=s.getParameter(H.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else l=0;return l}function h(H){return!(H!==mi&&r.convert(H)!==s.getParameter(s.IMPLEMENTATION_COLOR_READ_FORMAT))}function d(H){const j=H===Oo&&(e.has("EXT_color_buffer_half_float")||e.has("EXT_color_buffer_float"));return!(H!==ia&&r.convert(H)!==s.getParameter(s.IMPLEMENTATION_COLOR_READ_TYPE)&&H!==ta&&!j)}function p(H){if(H==="highp"){if(s.getShaderPrecisionFormat(s.VERTEX_SHADER,s.HIGH_FLOAT).precision>0&&s.getShaderPrecisionFormat(s.FRAGMENT_SHADER,s.HIGH_FLOAT).precision>0)return"highp";H="mediump"}return H==="mediump"&&s.getShaderPrecisionFormat(s.VERTEX_SHADER,s.MEDIUM_FLOAT).precision>0&&s.getShaderPrecisionFormat(s.FRAGMENT_SHADER,s.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let m=i.precision!==void 0?i.precision:"highp";const g=p(m);g!==m&&(console.warn("THREE.WebGLRenderer:",m,"not supported, using",g,"instead."),m=g);const v=i.logarithmicDepthBuffer===!0,x=i.reverseDepthBuffer===!0&&e.has("EXT_clip_control"),M=s.getParameter(s.MAX_TEXTURE_IMAGE_UNITS),A=s.getParameter(s.MAX_VERTEX_TEXTURE_IMAGE_UNITS),C=s.getParameter(s.MAX_TEXTURE_SIZE),y=s.getParameter(s.MAX_CUBE_MAP_TEXTURE_SIZE),_=s.getParameter(s.MAX_VERTEX_ATTRIBS),B=s.getParameter(s.MAX_VERTEX_UNIFORM_VECTORS),N=s.getParameter(s.MAX_VARYING_VECTORS),w=s.getParameter(s.MAX_FRAGMENT_UNIFORM_VECTORS),V=A>0,I=s.getParameter(s.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:u,getMaxPrecision:p,textureFormatReadable:h,textureTypeReadable:d,precision:m,logarithmicDepthBuffer:v,reverseDepthBuffer:x,maxTextures:M,maxVertexTextures:A,maxTextureSize:C,maxCubemapSize:y,maxAttributes:_,maxVertexUniforms:B,maxVaryings:N,maxFragmentUniforms:w,vertexTextures:V,maxSamples:I}}function FT(s){const e=this;let i=null,r=0,l=!1,u=!1;const h=new dr,d=new se,p={value:null,needsUpdate:!1};this.uniform=p,this.numPlanes=0,this.numIntersection=0,this.init=function(v,x){const M=v.length!==0||x||r!==0||l;return l=x,r=v.length,M},this.beginShadows=function(){u=!0,g(null)},this.endShadows=function(){u=!1},this.setGlobalState=function(v,x){i=g(v,x,0)},this.setState=function(v,x,M){const A=v.clippingPlanes,C=v.clipIntersection,y=v.clipShadows,_=s.get(v);if(!l||A===null||A.length===0||u&&!y)u?g(null):m();else{const B=u?0:r,N=B*4;let w=_.clippingState||null;p.value=w,w=g(A,x,N,M);for(let V=0;V!==N;++V)w[V]=i[V];_.clippingState=w,this.numIntersection=C?this.numPlanes:0,this.numPlanes+=B}};function m(){p.value!==i&&(p.value=i,p.needsUpdate=r>0),e.numPlanes=r,e.numIntersection=0}function g(v,x,M,A){const C=v!==null?v.length:0;let y=null;if(C!==0){if(y=p.value,A!==!0||y===null){const _=M+C*4,B=x.matrixWorldInverse;d.getNormalMatrix(B),(y===null||y.length<_)&&(y=new Float32Array(_));for(let N=0,w=M;N!==C;++N,w+=4)h.copy(v[N]).applyMatrix4(B,d),h.normal.toArray(y,w),y[w+3]=h.constant}p.value=y,p.needsUpdate=!0}return e.numPlanes=C,e.numIntersection=0,y}}function HT(s){let e=new WeakMap;function i(h,d){return d===Ch?h.mapping=Ss:d===wh&&(h.mapping=ys),h}function r(h){if(h&&h.isTexture){const d=h.mapping;if(d===Ch||d===wh)if(e.has(h)){const p=e.get(h).texture;return i(p,h.mapping)}else{const p=h.image;if(p&&p.height>0){const m=new Xy(p.height);return m.fromEquirectangularTexture(s,h),e.set(h,m),h.addEventListener("dispose",l),i(m.texture,h.mapping)}else return null}}return h}function l(h){const d=h.target;d.removeEventListener("dispose",l);const p=e.get(d);p!==void 0&&(e.delete(d),p.dispose())}function u(){e=new WeakMap}return{get:r,dispose:u}}const ms=4,B_=[.125,.215,.35,.446,.526,.582],gr=20,hh=new Qy,z_=new Be;let dh=null,ph=0,mh=0,gh=!1;const pr=(1+Math.sqrt(5))/2,ps=1/pr,I_=[new rt(-pr,ps,0),new rt(pr,ps,0),new rt(-ps,0,pr),new rt(ps,0,pr),new rt(0,pr,-ps),new rt(0,pr,ps),new rt(-1,1,-1),new rt(1,1,-1),new rt(-1,1,1),new rt(1,1,1)],GT=new rt;class F_{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(e,i=0,r=.1,l=100,u={}){const{size:h=256,position:d=GT}=u;dh=this._renderer.getRenderTarget(),ph=this._renderer.getActiveCubeFace(),mh=this._renderer.getActiveMipmapLevel(),gh=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(h);const p=this._allocateTargets();return p.depthBuffer=!0,this._sceneToCubeUV(e,r,l,p,d),i>0&&this._blur(p,0,0,i),this._applyPMREM(p),this._cleanup(p),p}fromEquirectangular(e,i=null){return this._fromTexture(e,i)}fromCubemap(e,i=null){return this._fromTexture(e,i)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=V_(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=G_(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodPlanes.length;e++)this._lodPlanes[e].dispose()}_cleanup(e){this._renderer.setRenderTarget(dh,ph,mh),this._renderer.xr.enabled=gh,e.scissorTest=!1,pc(e,0,0,e.width,e.height)}_fromTexture(e,i){e.mapping===Ss||e.mapping===ys?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),dh=this._renderer.getRenderTarget(),ph=this._renderer.getActiveCubeFace(),mh=this._renderer.getActiveMipmapLevel(),gh=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const r=i||this._allocateTargets();return this._textureToCubeUV(e,r),this._applyPMREM(r),this._cleanup(r),r}_allocateTargets(){const e=3*Math.max(this._cubeSize,112),i=4*this._cubeSize,r={magFilter:bi,minFilter:bi,generateMipmaps:!1,type:Oo,format:mi,colorSpace:Ms,depthBuffer:!1},l=H_(e,i,r);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==i){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=H_(e,i,r);const{_lodMax:u}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=VT(u)),this._blurMaterial=kT(u,e,i)}return l}_compileMaterial(e){const i=new Ai(this._lodPlanes[0],e);this._renderer.compile(i,hh)}_sceneToCubeUV(e,i,r,l,u){const p=new oi(90,1,i,r),m=[1,-1,1,1,1,1],g=[1,1,1,-1,-1,-1],v=this._renderer,x=v.autoClear,M=v.toneMapping;v.getClearColor(z_),v.toneMapping=Fa,v.autoClear=!1;const A=new _d({name:"PMREM.Background",side:Fn,depthWrite:!1,depthTest:!1}),C=new Ai(new bs,A);let y=!1;const _=e.background;_?_.isColor&&(A.color.copy(_),e.background=null,y=!0):(A.color.copy(z_),y=!0);for(let B=0;B<6;B++){const N=B%3;N===0?(p.up.set(0,m[B],0),p.position.set(u.x,u.y,u.z),p.lookAt(u.x+g[B],u.y,u.z)):N===1?(p.up.set(0,0,m[B]),p.position.set(u.x,u.y,u.z),p.lookAt(u.x,u.y+g[B],u.z)):(p.up.set(0,m[B],0),p.position.set(u.x,u.y,u.z),p.lookAt(u.x,u.y,u.z+g[B]));const w=this._cubeSize;pc(l,N*w,B>2?w:0,w,w),v.setRenderTarget(l),y&&v.render(C,p),v.render(e,p)}C.geometry.dispose(),C.material.dispose(),v.toneMapping=M,v.autoClear=x,e.background=_}_textureToCubeUV(e,i){const r=this._renderer,l=e.mapping===Ss||e.mapping===ys;l?(this._cubemapMaterial===null&&(this._cubemapMaterial=V_()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=G_());const u=l?this._cubemapMaterial:this._equirectMaterial,h=new Ai(this._lodPlanes[0],u),d=u.uniforms;d.envMap.value=e;const p=this._cubeSize;pc(i,0,0,3*p,2*p),r.setRenderTarget(i),r.render(h,hh)}_applyPMREM(e){const i=this._renderer,r=i.autoClear;i.autoClear=!1;const l=this._lodPlanes.length;for(let u=1;u<l;u++){const h=Math.sqrt(this._sigmas[u]*this._sigmas[u]-this._sigmas[u-1]*this._sigmas[u-1]),d=I_[(l-u-1)%I_.length];this._blur(e,u-1,u,h,d)}i.autoClear=r}_blur(e,i,r,l,u){const h=this._pingPongRenderTarget;this._halfBlur(e,h,i,r,l,"latitudinal",u),this._halfBlur(h,e,r,r,l,"longitudinal",u)}_halfBlur(e,i,r,l,u,h,d){const p=this._renderer,m=this._blurMaterial;h!=="latitudinal"&&h!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const g=3,v=new Ai(this._lodPlanes[l],m),x=m.uniforms,M=this._sizeLods[r]-1,A=isFinite(u)?Math.PI/(2*M):2*Math.PI/(2*gr-1),C=u/A,y=isFinite(u)?1+Math.floor(g*C):gr;y>gr&&console.warn(`sigmaRadians, ${u}, is too large and will clip, as it requested ${y} samples when the maximum is set to ${gr}`);const _=[];let B=0;for(let H=0;H<gr;++H){const j=H/C,D=Math.exp(-j*j/2);_.push(D),H===0?B+=D:H<y&&(B+=2*D)}for(let H=0;H<_.length;H++)_[H]=_[H]/B;x.envMap.value=e.texture,x.samples.value=y,x.weights.value=_,x.latitudinal.value=h==="latitudinal",d&&(x.poleAxis.value=d);const{_lodMax:N}=this;x.dTheta.value=A,x.mipInt.value=N-r;const w=this._sizeLods[l],V=3*w*(l>N-ms?l-N+ms:0),I=4*(this._cubeSize-w);pc(i,V,I,3*w,2*w),p.setRenderTarget(i),p.render(v,hh)}}function VT(s){const e=[],i=[],r=[];let l=s;const u=s-ms+1+B_.length;for(let h=0;h<u;h++){const d=Math.pow(2,l);i.push(d);let p=1/d;h>s-ms?p=B_[h-s+ms-1]:h===0&&(p=0),r.push(p);const m=1/(d-2),g=-m,v=1+m,x=[g,g,v,g,v,v,g,g,v,v,g,v],M=6,A=6,C=3,y=2,_=1,B=new Float32Array(C*A*M),N=new Float32Array(y*A*M),w=new Float32Array(_*A*M);for(let I=0;I<M;I++){const H=I%3*2/3-1,j=I>2?0:-1,D=[H,j,0,H+2/3,j,0,H+2/3,j+1,0,H,j,0,H+2/3,j+1,0,H,j+1,0];B.set(D,C*A*I),N.set(x,y*A*I);const R=[I,I,I,I,I,I];w.set(R,_*A*I)}const V=new Mr;V.setAttribute("position",new Ri(B,C)),V.setAttribute("uv",new Ri(N,y)),V.setAttribute("faceIndex",new Ri(w,_)),e.push(V),l>ms&&l--}return{lodPlanes:e,sizeLods:i,sigmas:r}}function H_(s,e,i){const r=new yr(s,e,i);return r.texture.mapping=Cc,r.texture.name="PMREM.cubeUv",r.scissorTest=!0,r}function pc(s,e,i,r,l){s.viewport.set(e,i,r,l),s.scissor.set(e,i,r,l)}function kT(s,e,i){const r=new Float32Array(gr),l=new rt(0,1,0);return new Ga({name:"SphericalGaussianBlur",defines:{n:gr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:vd(),fragmentShader:`
...
`)+`
`+_);const N=B+y+h,w=B+_+d,V=K_(l,l.VERTEX_SHADER,N),I=K_(l,l.FRAGMENT_SHADER,w);l.attachShader(C,V),l.attachShader(C,I),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function H(k){if(s.debug.checkShaderErrors){const lt=l.getProgramInfoLog(C).trim(),st=l.getShaderInfoLog(V).trim(),ut=l.getShaderInfoLog(I).trim();let _t=!0,O=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(_t=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,C,V,I);else{const $=J_(l,V,"vertex"),q=J_(l,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
}`;function EA(s,e,i){let r=new O0;const l=new He,u=new He,h=new $e,d=new Zy({depthPacking:sy}),p=new Ky,m={},g=i.maxTextureSize,v={[Ha]:Fn,[Fn]:Ha,[$i]:$i},x=new Ga({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new He},radius:{value:4}},vertexShader:yA,fragmentShader:MA}),M=x.clone();M.defines.HORIZONTAL_PASS=1;const A=new Mr;A.setAttribute("position",new Ri(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Ai(A,x),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=d0;let _=this.type;this.render=function(I,H,j){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||I.length===0)return;const D=s.getRenderTarget(),R=s.getActiveCubeFace(),k=s.getActiveMipmapLevel(),lt=s.state;lt.setBlending(Ia),lt.buffers.color.setClear(1,1,1,1),lt.buffers.depth.setTest(!0),lt.setScissorTest(!1);const st=_!==Ji&&this.type===Ji,ut=_===Ji&&this.type!==Ji;for(let _t=0,O=I.length;_t<O;_t++){const $=I[_t],q=$.shadow;if(q===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;l.copy(q.mapSize);const Mt=q.getFrameExtents();if(l.multiply(Mt),u.copy(q.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(u.x=Math.floor(g/Mt.x),l.x=u.x*Mt.x,q.mapSize.x=u.x),l.y>g&&(u.y=Math.floor(g/Mt.y),l.y=u.y*Mt.y,q.mapSize.y=u.y)),q.map===null||st===!0||ut===!0){const J=this.type!==Ji?{minFilter:gi,magFilter:gi}:{};q.map!==null&&q.map.dispose(),q.map=new yr(l.x,l.y,J),q.map.texture.name=$.name+".shadowMap",q.camera.updateProjectionMatrix()}s.setRenderTarget(q.map),s.clear();const U=q.getViewportCount();for(let J=0;J<U;J++){const vt=q.getViewport(J);h.set(u.x*vt.x,u.y*vt.y,u.x*vt.z,u.y*vt.w),lt.viewport(h),q.updateMatrices($,J),r=q.getFrustum(),w(H,j,q.camera,$,this.type)}q.isPointLightShadow!==!0&&this.type===Ji&&B(q,j),q.needsUpdate=!1}_=this.type,y.needsUpdate=!1,s.setRenderTarget(D,R,k)};function B(I,H){const j=e.update(C);x.defines.VSM_SAMPLES!==I.blurSamples&&(x.defines.VSM_SAMPLES=I.blurSamples,M.defines.VSM_SAMPLES=I.blurSamples,x.needsUpdate=!0,M.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new yr(l.x,l.y)),x.uniforms.shadow_pass.value=I.map.texture,x.uniforms.resolution.value=I.mapSize,x.uniforms.radius.value=I.radius,s.setRenderTarget(I.mapPass),s.clear(),s.renderBufferDirect(H,null,j,x,C,null),M.uniforms.shadow_pass.value=I.mapPass.texture,M.uniforms.resolution.value=I.mapSize,M.uniforms.radius.value=I.radius,s.setRenderTarget(I.map),s.clear(),s.renderBufferDirect(H,null,j,M,C,null)}function N(I,H,j,D){let R=null;const k=j.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(k!==void 0)R=k;else if(R=j.isPointLight===!0?p:d,s.localClippingEnabled&&H.clipShadows===!0&&Array.isArray(H.clippingPlanes)&&H.clippingPlanes.length!==0||H.displacementMap&&H.displacementScale!==0||H.alphaMap&&H.alphaTest>0||H.map&&H.alphaTest>0||H.alphaToCoverage===!0){const lt=R.uuid,st=H.uuid;let ut=m[lt];ut===void 0&&(ut={},m[lt]=ut);let _t=ut[st];_t===void 0&&(_t=R.clone(),ut[st]=_t,H.addEventListener("dispose",V)),R=_t}if(R.visible=H.visible,R.wireframe=H.wireframe,D===Ji?R.side=H.shadowSide!==null?H.shadowSide:H.side:R.side=H.shadowSide!==null?H.shadowSide:v[H.side],R.alphaMap=H.alphaMap,R.alphaTest=H.alphaToCoverage===!0?.5:H.alphaTest,R.map=H.map,R.clipShadows=H.clipShadows,R.clippingPlanes=H.clippingPlanes,R.clipIntersection=H.clipIntersection,R.displacementMap=H.displacementMap,R.displacementScale=H.displacementScale,R.displacementBias=H.displacementBias,R.wireframeLinewidth=H.wireframeLinewidth,R.linewidth=H.linewidth,j.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const lt=s.properties.get(R);lt.light=j}return R}function w(I,H,j,D,R){if(I.visible===!1)return;if(I.layers.test(H.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&R===Ji)&&(!I.frustumCulled||r.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,I.matrixWorld);const st=e.update(I),ut=I.material;if(Array.isArray(ut)){const _t=st.groups;for(let O=0,$=_t.length;O<$;O++){const q=_t[O],Mt=ut[q.materialIndex];if(Mt&&Mt.visible){const U=N(I,Mt,D,R);I.onBeforeShadow(s,I,H,j,st,U,q),s.renderBufferDirect(j,null,st,U,I,q),I.onAfterShadow(s,I,H,j,st,U,q)}}}else if(ut.visible){const _t=N(I,ut,D,R);I.onBeforeShadow(s,I,H,j,st,_t,null),s.renderBufferDirect(j,null,st,_t,I,null),I.onAfterShadow(s,I,H,j,st,_t,null)}}const lt=I.children;for(let st=0,ut=lt.length;st<ut;st++)w(lt[st],H,j,D,R)}function V(I){I.target.removeEventListener("dispose",V);for(const j in m){const D=m[j],R=I.target.uuid;R in D&&(D[R].dispose(),delete D[R])}}}const TA={[yh]:Mh,[Eh]:Ah,[Th]:Rh,[xs]:bh,[Mh]:yh,[Ah]:Eh,[Rh]:Th,[bh]:xs};function bA(s,e){function i(){let G=!1;const Lt=new $e;let Et=null;const zt=new $e(0,0,0,0);return{setMask:function(At){Et!==At&&!G&&(s.colorMask(At,At,At,At),Et=At)},setLocked:function(At){G=At},setClear:function(At,gt,Ft,ne,Ce){Ce===!0&&(At*=ne,gt*=ne,Ft*=ne),Lt.set(At,gt,Ft,ne),zt.equals(Lt)===!1&&(s.clearColor(At,gt,Ft,ne),zt.copy(Lt))},reset:function(){G=!1,Et=null,zt.set(-1,0,0,0)}}}function r(){let G=!1,Lt=!1,Et=null,zt=null,At=null;return{setReversed:function(gt){if(Lt!==gt){const Ft=e.get("EXT_clip_control");gt?Ft.clipControlEXT(Ft.LOWER_LEFT_EXT,Ft.ZERO_TO_ONE_EXT):Ft.clipControlEXT(Ft.LOWER_LEFT_EXT,Ft.NEGATIVE_ONE_TO_ONE_EXT),Lt=gt;const ne=At;At=null,this.setClear(ne)}},getReversed:function(){return Lt},setTest:function(gt){gt?Rt(s.DEPTH_TEST):wt(s.DEPTH_TEST)},setMask:function(gt){Et!==gt&&!G&&(s.depthMask(gt),Et=gt)},setFunc:function(gt){if(Lt&&(gt=TA[gt]),zt!==gt){switch(gt){case yh:s.depthFunc(s.NEVER);break;case Mh:s.depthFunc(s.ALWAYS);break;case Eh:s.depthFunc(s.LESS);break;case xs:s.depthFunc(s.LEQUAL);break;case Th:s.depthFunc(s.EQUAL);break;case bh:s.depthFunc(s.GEQUAL);break;case Ah:s.depthFunc(s.GREATER);break;case Rh:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}zt=gt}},setLocked:function(gt){G=gt},setClear:function(gt){At!==gt&&(Lt&&(gt=1-gt),s.clearDepth(gt),At=gt)},reset:function(){G=!1,Et=null,zt=null,At=null,Lt=!1}}}function l(){let G=!1,Lt=null,Et=null,zt=null,At=null,gt=null,Ft=null,ne=null,Ce=null;return{setTest:function(Ee){G||(Ee?Rt(s.STENCIL_TEST):wt(s.STENCIL_TEST))},setMask:function(Ee){Lt!==Ee&&!G&&(s.stencilMask(Ee),Lt=Ee)},setFunc:function(Ee,Gn,hn){(Et!==Ee||zt!==Gn||At!==hn)&&(s.stencilFunc(Ee,Gn,hn),Et=Ee,zt=Gn,At=hn)},setOp:function(Ee,Gn,hn){(gt!==Ee||Ft!==Gn||ne!==hn)&&(s.stencilOp(Ee,Gn,hn),gt=Ee,Ft=Gn,ne=hn)},setLocked:function(Ee){G=Ee},setClear:function(Ee){Ce!==Ee&&(s.clearStencil(Ee),Ce=Ee)},reset:function(){G=!1,Lt=null,Et=null,zt=null,At=null,gt=null,Ft=null,ne=null,Ce=null}}}const u=new i,h=new r,d=new l,p=new WeakMap,m=new WeakMap;let g={},v={},x=new WeakMap,M=[],A=null,C=!1,y=null,_=null,B=null,N=null,w=null,V=null,I=null,H=new Be(0,0,0),j=0,D=!1,R=null,k=null,lt=null,st=null,ut=null;const _t=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,$=0;const q=s.getParameter(s.VERSION);q.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(q)[1]),O=$>=1):q.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),O=$>=2);let Mt=null,U={};const J=s.getParameter(s.SCISSOR_BOX),vt=s.getParameter(s.VIEWPORT),St=new $e().fromArray(J),K=new $e().fromArray(vt);function pt(G,Lt,Et,zt){const At=new Uint8Array(4),gt=s.createTexture();s.bindTexture(G,gt),s.texParameteri(G,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(G,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Ft=0;Ft<Et;Ft++)G===s.TEXTURE_3D||G===s.TEXTURE_2D_ARRAY?s.texImage3D(Lt,0,s.RGBA,1,1,zt,0,s.RGBA,s.UNSIGNED_BYTE,At):s.texImage2D(Lt+Ft,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,At);return gt}const yt={};yt[s.TEXTURE_2D]=pt(s.TEXTURE_2D,s.TEXTURE_2D,1),yt[s.TEXTURE_CUBE_MAP]=pt(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),yt[s.TEXTURE_2D_ARRAY]=pt(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),yt[s.TEXTURE_3D]=pt(s.TEXTURE_3D,s.TEXTURE_3D,1,1),u.setClear(0,0,0,1),h.setClear(1),d.setClear(0),Rt(s.DEPTH_TEST),h.setFunc(xs),ye(!1),he(f_),Rt(s.CULL_FACE),z(Ia);function Rt(G){g[G]!==!0&&(s.enable(G),g[G]=!0)}function wt(G){g[G]!==!1&&(s.disable(G),g[G]=!1)}function oe(G,Lt){return v[G]!==Lt?(s.bindFramebuffer(G,Lt),v[G]=Lt,G===s.DRAW_FRAMEBUFFER&&(v[s.FRAMEBUFFER]=Lt),G===s.FRAMEBUFFER&&(v[s.DRAW_FRAMEBUFFER]=Lt),!0):!1}function Qt(G,Lt){let Et=M,zt=!1;if(G){Et=x.get(Lt),Et===void 0&&(Et=[],x.set(Lt,Et));const At=G.textures;if(Et.length!==At.length||Et[0]!==s.COLOR_ATTACHMENT0){for(let gt=0,Ft=At.length;gt<Ft;gt++)Et[gt]=s.COLOR_ATTACHMENT0+gt;Et.length=At.length,zt=!0}}else Et[0]!==s.BACK&&(Et[0]=s.BACK,zt=!0);zt&&s.drawBuffers(Et)}function Ue(G){return A!==G?(s.useProgram(G),A=G,!0):!1}const ze={[mr]:s.FUNC_ADD,[LS]:s.FUNC_SUBTRACT,[NS]:s.FUNC_REVERSE_SUBTRACT};ze[OS]=s.MIN,ze[PS]=s.MAX;const me={[BS]:s.ZERO,[zS]:s.ONE,[IS]:s.SRC_COLOR,[xh]:s.SRC_ALPHA,[XS]:s.SRC_ALPHA_SATURATE,[VS]:s.DST_COLOR,[HS]:s.DST_ALPHA,[FS]:s.ONE_MINUS_SRC_COLOR,[Sh]:s.ONE_MINUS_SRC_ALPHA,[kS]:s.ONE_MINUS_DST_COLOR,[GS]:s.ONE_MINUS_DST_ALPHA,[WS]:s.CONSTANT_COLOR,[qS]:s.ONE_MINUS_CONSTANT_COLOR,[YS]:s.CONSTANT_ALPHA,[jS]:s.ONE_MINUS_CONSTANT_ALPHA};function z(G,Lt,Et,zt,At,gt,Ft,ne,Ce,Ee){if(G===Ia){C===!0&&(wt(s.BLEND),C=!1);return}if(C===!1&&(Rt(s.BLEND),C=!0),G!==US){if(G!==y||Ee!==D){if((_!==mr||w!==mr)&&(s.blendEquation(s.FUNC_ADD),_=mr,w=mr),Ee)switch(G){case gs:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case h_:s.blendFunc(s.ONE,s.ONE);break;case d_:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case p_:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",G);break}else switch(G){case gs:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case h_:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case d_:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case p_:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",G);break}B=null,N=null,V=null,I=null,H.set(0,0,0),j=0,y=G,D=Ee}return}At=At||Lt,gt=gt||Et,Ft=Ft||zt,(Lt!==_||At!==w)&&(s.blendEquationSeparate(ze[Lt],ze[At]),_=Lt,w=At),(Et!==B||zt!==N||gt!==V||Ft!==I)&&(s.blendFuncSeparate(me[Et],me[zt],me[gt],me[Ft]),B=Et,N=zt,V=gt,I=Ft),(ne.equals(H)===!1||Ce!==j)&&(s.blendColor(ne.r,ne.g,ne.b,Ce),H.copy(ne),j=Ce),y=G,D=!1}function xn(G,Lt){G.side===$i?wt(s.CULL_FACE):Rt(s.CULL_FACE);let Et=G.side===Fn;Lt&&(Et=!Et),ye(Et),G.blending===gs&&G.transparent===!1?z(Ia):z(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),h.setFunc(G.depthFunc),h.setTest(G.depthTest),h.setMask(G.depthWrite),u.setMask(G.colorWrite);const zt=G.stencilWrite;d.setTest(zt),zt&&(d.setMask(G.stencilWriteMask),d.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),d.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),ge(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?Rt(s.SAMPLE_ALPHA_TO_COVERAGE):wt(s.SAMPLE_ALPHA_TO_COVERAGE)}function ye(G){R!==G&&(G?s.frontFace(s.CW):s.frontFace(s.CCW),R=G)}function he(G){G!==CS?(Rt(s.CULL_FACE),G!==k&&(G===f_?s.cullFace(s.BACK):G===wS?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):wt(s.CULL_FACE),k=G}function Vt(G){G!==lt&&(O&&s.lineWidth(G),lt=G)}function ge(G,Lt,Et){G?(Rt(s.POLYGON_OFFSET_FILL),(st!==Lt||ut!==Et)&&(s.polygonOffset(Lt,Et),st=Lt,ut=Et)):wt(s.POLYGON_OFFSET_FILL)}function jt(G){G?Rt(s.SCISSOR_TEST):wt(s.SCISSOR_TEST)}function ae(G){G===void 0&&(G=s.TEXTURE0+_t-1),Mt!==G&&(s.activeTexture(G),Mt=G)}function Ke(G,Lt,Et){Et===void 0&&(Mt===null?Et=s.TEXTURE0+_t-1:Et=Mt);let zt=U[Et];zt===void 0&&(zt={type:void 0,texture:void 0},U[Et]=zt),(zt.type!==G||zt.texture!==Lt)&&(Mt!==Et&&(s.activeTexture(Et),Mt=Et),s.bindTexture(G,Lt||yt[G]),zt.type=G,zt.texture=Lt)}function L(){const G=U[Mt];G!==void 0&&G.type!==void 0&&(s.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function E(){try{s.compressedTexImage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function tt(){try{s.compressedTexImage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function ft(){try{s.texSubImage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function dt(){try{s.texSubImage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function ot(){try{s.compressedTexSubImage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Pt(){try{s.compressedTexSubImage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Ut(){try{s.texStorage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Gt(){try{s.texStorage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function kt(){try{s.texImage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function xt(){try{s.texImage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Bt(G){St.equals(G)===!1&&(s.scissor(G.x,G.y,G.z,G.w),St.copy(G))}function qt(G){K.equals(G)===!1&&(s.viewport(G.x,G.y,G.z,G.w),K.copy(G))}function Yt(G,Lt){let Et=m.get(Lt);Et===void 0&&(Et=new WeakMap,m.set(Lt,Et));let zt=Et.get(G);zt===void 0&&(zt=s.getUniformBlockIndex(Lt,G.name),Et.set(G,zt))}function Ct(G,Lt){const zt=m.get(Lt).get(G);p.get(Lt)!==zt&&(s.uniformBlockBinding(Lt,zt,G.__bindingPointIndex),p.set(Lt,zt))}function ie(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),h.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),g={},Mt=null,U={},v={},x=new WeakMap,M=[],A=null,C=!1,y=null,_=null,B=null,N=null,w=null,V=null,I=null,H=new Be(0,0,0),j=0,D=!1,R=null,k=null,lt=null,st=null,ut=null,St.set(0,0,s.canvas.width,s.canvas.height),K.set(0,0,s.canvas.width,s.canvas.height),u.reset(),h.reset(),d.reset()}return{buffers:{color:u,depth:h,stencil:d},enable:Rt,disable:wt,bindFramebuffer:oe,drawBuffers:Qt,useProgram:Ue,setBlending:z,setMaterial:xn,setFlipSided:ye,setCullFace:he,setLineWidth:Vt,setPolygonOffset:ge,setScissorTest:jt,activeTexture:ae,bindTexture:Ke,unbindTexture:L,compressedTexImage2D:E,compressedTexImage3D:tt,texImage2D:kt,texImage3D:xt,updateUBOMapping:Yt,uniformBlockBinding:Ct,texStorage2D:Ut,texStorage3D:Gt,texSubImage2D:ft,texSubImage3D:dt,compressedTexSubImage2D:ot,compressedTexSubImage3D:Pt,scissor:Bt,viewport:qt,reset:ie}}function AA(s,e,i,r,l,u,h){const d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new He,g=new WeakMap;let v;const x=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function A(L,E){return M?new OffscreenCanvas(L,E):bc("canvas")}function C(L,E,tt){let ft=1;const dt=Ke(L);if((dt.width>tt||dt.height>tt)&&(ft=tt/Math.max(dt.width,dt.height)),ft<1)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap||typeof VideoFrame<"u"&&L instanceof VideoFrame){const ot=Math.floor(ft*dt.width),Pt=Math.floor(ft*dt.height);v===void 0&&(v=A(ot,Pt));const Ut=E?A(ot,Pt):v;return Ut.width=ot,Ut.height=Pt,Ut.getContext("2d").drawImage(L,0,0,ot,Pt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+dt.width+"x"+dt.height+") to ("+ot+"x"+Pt+")."),Ut}else return"data"in L&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+dt.width+"x"+dt.height+")."),L;return L}function y(L){return L.generateMipmaps}function _(L){s.generateMipmap(L)}function B(L){return L.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:L.isWebGL3DRenderTarget?s.TEXTURE_3D:L.isWebGLArrayRenderTarget||L.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function N(L,E,tt,ft,dt=!1){if(L!==null){if(s[L]!==void 0)return s[L];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let ot=E;if(E===s.RED&&(tt===s.FLOAT&&(ot=s.R32F),tt===s.HALF_FLOAT&&(ot=s.R16F),tt===s.UNSIGNED_BYTE&&(ot=s.R8)),E===s.RED_INTEGER&&(tt===s.UNSIGNED_BYTE&&(ot=s.R8UI),tt===s.UNSIGNED_SHORT&&(ot=s.R16UI),tt===s.UNSIGNED_INT&&(ot=s.R32UI),tt===s.BYTE&&(ot=s.R8I),tt===s.SHORT&&(ot=s.R16I),tt===s.INT&&(ot=s.R32I)),E===s.RG&&(tt===s.FLOAT&&(ot=s.RG32F),tt===s.HALF_FLOAT&&(ot=s.RG16F),tt===s.UNSIGNED_BYTE&&(ot=s.RG8)),E===s.RG_INTEGER&&(tt===s.UNSIGNED_BYTE&&(ot=s.RG8UI),tt===s.UNSIGNED_SHORT&&(ot=s.RG16UI),tt===s.UNSIGNED_INT&&(ot=s.RG32UI),tt===s.BYTE&&(ot=s.RG8I),tt===s.SHORT&&(ot=s.RG16I),tt===s.INT&&(ot=s.RG32I)),E===s.RGB_INTEGER&&(tt===s.UNSIGNED_BYTE&&(ot=s.RGB8UI),tt===s.UNSIGNED_SHORT&&(ot=s.RGB16UI),tt===s.UNSIGNED_INT&&(ot=s.RGB32UI),tt===s.BYTE&&(ot=s.RGB8I),tt===s.SHORT&&(ot=s.RGB16I),tt===s.INT&&(ot=s.RGB32I)),E===s.RGBA_INTEGER&&(tt===s.UNSIGNED_BYTE&&(ot=s.RGBA8UI),tt===s.UNSIGNED_SHORT&&(ot=s.RGBA16UI),tt===s.UNSIGNED_INT&&(ot=s.RGBA32UI),tt===s.BYTE&&(ot=s.RGBA8I),tt===s.SHORT&&(ot=s.RGBA16I),tt===s.INT&&(ot=s.RGBA32I)),E===s.RGB&&tt===s.UNSIGNED_INT_5_9_9_9_REV&&(ot=s.RGB9_E5),E===s.RGBA){const Pt=dt?Ec:be.getTransfer(ft);tt===s.FLOAT&&(ot=s.RGBA32F),tt===s.HALF_FLOAT&&(ot=s.RGBA16F),tt===s.UNSIGNED_BYTE&&(ot=Pt===Pe?s.SRGB8_ALPHA8:s.RGBA8),tt===s.UNSIGNED_SHORT_4_4_4_4&&(ot=s.RGBA4),tt===s.UNSIGNED_SHORT_5_5_5_1&&(ot=s.RGB5_A1)}return(ot===s.R16F||ot===s.R32F||ot===s.RG16F||ot===s.RG32F||ot===s.RGBA16F||ot===s.RGBA32F)&&e.get("EXT_color_buffer_float"),ot}function w(L,E){let tt;return L?E===null||E===Sr||E===Uo?tt=s.DEPTH24_STENCIL8:E===ta?tt=s.DEPTH32F_STENCIL8:E===Do&&(tt=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Sr||E===Uo?tt=s.DEPTH_COMPONENT24:E===ta?tt=s.DEPTH_COMPONENT32F:E===Do&&(tt=s.DEPTH_COMPONENT16),tt}function V(L,E){return y(L)===!0||L.isFramebufferTexture&&L.minFilter!==gi&&L.minFilter!==bi?Math.log2(Math.max(E.width,E.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?E.mipmaps.length:1}function I(L){const E=L.target;E.removeEventListener("dispose",I),j(E),E.isVideoTexture&&g.delete(E)}function H(L){const E=L.target;E.removeEventListener("dispose",H),R(E)}function j(L){const E=r.get(L);if(E.__webglInit===void 0)return;const tt=L.source,ft=x.get(tt);if(ft){const dt=ft[E.__cacheKey];dt.usedTimes--,dt.usedTimes===0&&D(L),Object.keys(ft).length===0&&x.delete(tt)}r.remove(L)}function D(L){const E=r.get(L);s.deleteTexture(E.__webglTexture);const tt=L.source,ft=x.get(tt);delete ft[E.__cacheKey],h.memory.textures--}function R(L){const E=r.get(L);if(L.depthTexture&&(L.depthTexture.dispose(),r.remove(L.depthTexture)),L.isWebGLCubeRenderTarget)for(let ft=0;ft<6;ft++){if(Array.isArray(E.__webglFramebuffer[ft]))for(let dt=0;dt<E.__webglFramebuffer[ft].length;dt++)s.deleteFramebuffer(E.__webglFramebuffer[ft][dt]);else s.deleteFramebuffer(E.__webglFramebuffer[ft]);E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer[ft])}else{if(Array.isArray(E.__webglFramebuffer))for(let ft=0;ft<E.__webglFramebuffer.length;ft++)s.deleteFramebuffer(E.__webglFramebuffer[ft]);else s.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&s.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ft=0;ft<E.__webglColorRenderbuffer.length;ft++)E.__webglColorRenderbuffer[ft]&&s.deleteRenderbuffer(E.__webglColorRenderbuffer[ft]);E.__webglDepthRenderbuffer&&s.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const tt=L.textures;for(let ft=0,dt=tt.length;ft<dt;ft++){const ot=r.get(tt[ft]);ot.__webglTexture&&(s.deleteTexture(ot.__webglTexture),h.memory.textures--),r.remove(tt[ft])}r.remove(L)}let k=0;function lt(){k=0}function st(){const L=k;return L>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+l.maxTextures),k+=1,L}function ut(L){const E=[];return E.push(L.wrapS),E.push(L.wrapT),E.push(L.wrapR||0),E.push(L.magFilter),E.push(L.minFilter),E.push(L.anisotropy),E.push(L.internalFormat),E.push(L.format),E.push(L.type),E.push(L.generateMipmaps),E.push(L.premultiplyAlpha),E.push(L.flipY),E.push(L.unpackAlignment),E.push(L.colorSpace),E.join()}function _t(L,E){const tt=r.get(L);if(L.isVideoTexture&&jt(L),L.isRenderTargetTexture===!1&&L.version>0&&tt.__version!==L.version){const ft=L.image;if(ft===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ft.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{yt(tt,L,E);return}}i.bindTexture(s.TEXTURE_2D,tt.__webglTexture,s.TEXTURE0+E)}function O(L,E){const tt=r.get(L);if(L.version>0&&tt.__version!==L.version){yt(tt,L,E);return}i.bindTexture(s.TEXTURE_2D_ARRAY,tt.__webglTexture,s.TEXTURE0+E)}function $(L,E){const tt=r.get(L);if(L.version>0&&tt.__version!==L.version){yt(tt,L,E);return}i.bindTexture(s.TEXTURE_3D,tt.__webglTexture,s.TEXTURE0+E)}function q(L,E){const tt=r.get(L);if(L.version>0&&tt.__version!==L.version){Rt(tt,L,E);return}i.bindTexture(s.TEXTURE_CUBE_MAP,tt.__webglTexture,s.TEXTURE0+E)}const Mt={[Dh]:s.REPEAT,[_r]:s.CLAMP_TO_EDGE,[Uh]:s.MIRRORED_REPEAT},U={[gi]:s.NEAREST,[ay]:s.NEAREST_MIPMAP_NEAREST,[Zl]:s.NEAREST_MIPMAP_LINEAR,[bi]:s.LINEAR,[Gf]:s.LINEAR_MIPMAP_NEAREST,[vr]:s.LINEAR_MIPMAP_LINEAR},J={[cy]:s.NEVER,[my]:s.ALWAYS,[uy]:s.LESS,[T0]:s.LEQUAL,[fy]:s.EQUAL,[py]:s.GEQUAL,[hy]:s.GREATER,[dy]:s.NOTEQUAL};function vt(L,E){if(E.type===ta&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===bi||E.magFilter===Gf||E.magFilter===Zl||E.magFilter===vr||E.minFilter===bi||E.minFilter===Gf||E.minFilter===Zl||E.minFilter===vr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(L,s.TEXTURE_WRAP_S,Mt[E.wrapS]),s.texParameteri(L,s.TEXTURE_WRAP_T,Mt[E.wrapT]),(L===s.TEXTURE_3D||L===s.TEXTURE_2D_ARRAY)&&s.texParameteri(L,s.TEXTURE_WRAP_R,Mt[E.wrapR]),s.texParameteri(L,s.TEXTURE_MAG_FILTER,U[E.magFilter]),s.texParameteri(L,s.TEXTURE_MIN_FILTER,U[E.minFilter]),E.compareFunction&&(s.texParameteri(L,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(L,s.TEXTURE_COMPARE_FUNC,J[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===gi||E.minFilter!==Zl&&E.minFilter!==vr||E.type===ta&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const tt=e.get("EXT_texture_filter_anisotropic");s.texParameterf(L,tt.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function St(L,E){let tt=!1;L.__webglInit===void 0&&(L.__webglInit=!0,E.addEventListener("dispose",I));const ft=E.source;let dt=x.get(ft);dt===void 0&&(dt={},x.set(ft,dt));const ot=ut(E);if(ot!==L.__cacheKey){dt[ot]===void 0&&(dt[ot]={texture:s.createTexture(),usedTimes:0},h.memory.textures++,tt=!0),dt[ot].usedTimes++;const Pt=dt[L.__cacheKey];Pt!==void 0&&(dt[L.__cacheKey].usedTimes--,Pt.usedTimes===0&&D(E)),L.__cacheKey=ot,L.__webglTexture=dt[ot].texture}return tt}function K(L,E,tt){return Math.floor(Math.floor(L/tt)/E)}function pt(L,E,tt,ft){const ot=L.updateRanges;if(ot.length===0)i.texSubImage2D(s.TEXTURE_2D,0,0,0,E.width,E.height,tt,ft,E.data);else{ot.sort((xt,Bt)=>xt.start-Bt.start);let Pt=0;for(let xt=1;xt<ot.length;xt++){const Bt=ot[Pt],qt=ot[xt],Yt=Bt.start+Bt.count,Ct=K(qt.start,E.width,4),ie=K(Bt.start,E.width,4);qt.start<=Yt+1&&Ct===ie&&K(qt.start+qt.count-1,E.width,4)===Ct?Bt.count=Math.max(Bt.count,qt.start+qt.count-Bt.start):(++Pt,ot[Pt]=qt)}ot.length=Pt+1;const Ut=s.getParameter(s.UNPACK_ROW_LENGTH),Gt=s.getParameter(s.UNPACK_SKIP_PIXELS),kt=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,E.width);for(let xt=0,Bt=ot.length;xt<Bt;xt++){const qt=ot[xt],Yt=Math.floor(qt.start/4),Ct=Math.ceil(qt.count/4),ie=Yt%E.width,G=Math.floor(Yt/E.width),Lt=Ct,Et=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,ie),s.pixelStorei(s.UNPACK_SKIP_ROWS,G),i.texSubImage2D(s.TEXTURE_2D,0,ie,G,Lt,Et,tt,ft,E.data)}L.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,Ut),s.pixelStorei(s.UNPACK_SKIP_PIXELS,Gt),s.pixelStorei(s.UNPACK_SKIP_ROWS,kt)}}function yt(L,E,tt){let ft=s.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ft=s.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ft=s.TEXTURE_3D);const dt=St(L,E),ot=E.source;i.bindTexture(ft,L.__webglTexture,s.TEXTURE0+tt);const Pt=r.get(ot);if(ot.version!==Pt.__version||dt===!0){i.activeTexture(s.TEXTURE0+tt);const Ut=be.getPrimaries(be.workingColorSpace),Gt=E.colorSpace===za?null:be.getPrimaries(E.colorSpace),kt=E.colorSpace===za||Ut===Gt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,kt);let xt=C(E.image,!1,l.maxTextureSize);xt=ae(E,xt);const Bt=u.convert(E.format,E.colorSpace),qt=u.convert(E.type);let Yt=N(E.internalFormat,Bt,qt,E.colorSpace,E.isVideoTexture);vt(ft,E);let Ct;const ie=E.mipmaps,G=E.isVideoTexture!==!0,Lt=Pt.__version===void 0||dt===!0,Et=ot.dataReady,zt=V(E,xt);if(E.isDepthTexture)Yt=w(E.format===No,E.type),Lt&&(G?i.texStorage2D(s.TEXTURE_2D,1,Yt,xt.width,xt.height):i.texImage2D(s.TEXTURE_2D,0,Yt,xt.width,xt.height,0,Bt,qt,null));else if(E.isDataTexture)if(ie.length>0){G&&Lt&&i.texStorage2D(s.TEXTURE_2D,zt,Yt,ie[0].width,ie[0].height);for(let At=0,gt=ie.length;At<gt;At++)Ct=ie[At],G?Et&&i.texSubImage2D(s.TEXTURE_2D,At,0,0,Ct.width,Ct.height,Bt,qt,Ct.data):i.texImage2D(s.TEXTURE_2D,At,Yt,Ct.width,Ct.height,0,Bt,qt,Ct.data);E.generateMipmaps=!1}else G?(Lt&&i.texStorage2D(s.TEXTURE_2D,zt,Yt,xt.width,xt.height),Et&&pt(E,xt,Bt,qt)):i.texImage2D(s.TEXTURE_2D,0,Yt,xt.width,xt.height,0,Bt,qt,xt.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){G&&Lt&&i.texStorage3D(s.TEXTURE_2D_ARRAY,zt,Yt,ie[0].width,ie[0].height,xt.depth);for(let At=0,gt=ie.length;At<gt;At++)if(Ct=ie[At],E.format!==mi)if(Bt!==null)if(G){if(Et)if(E.layerUpdates.size>0){const Ft=P_(Ct.width,Ct.height,E.format,E.type);for(const ne of E.layerUpdates){const Ce=Ct.data.subarray(ne*Ft/Ct.data.BYTES_PER_ELEMENT,(ne+1)*Ft/Ct.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,At,0,0,ne,Ct.width,Ct.height,1,Bt,Ce)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,At,0,0,0,Ct.width,Ct.height,xt.depth,Bt,Ct.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,At,Yt,Ct.width,Ct.height,xt.depth,0,Ct.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else G?Et&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,At,0,0,0,Ct.width,Ct.height,xt.depth,Bt,qt,Ct.data):i.texImage3D(s.TEXTURE_2D_ARRAY,At,Yt,Ct.width,Ct.height,xt.depth,0,Bt,qt,Ct.data)}else{G&&Lt&&i.texStorage2D(s.TEXTURE_2D,zt,Yt,ie[0].width,ie[0].height);for(let At=0,gt=ie.length;At<gt;At++)Ct=ie[At],E.format!==mi?Bt!==null?G?Et&&i.compressedTexSubImage2D(s.TEXTURE_2D,At,0,0,Ct.width,Ct.height,Bt,Ct.data):i.compressedTexImage2D(s.TEXTURE_2D,At,Yt,Ct.width,Ct.height,0,Ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):G?Et&&i.texSubImage2D(s.TEXTURE_2D,At,0,0,Ct.width,Ct.height,Bt,qt,Ct.data):i.texImage2D(s.TEXTURE_2D,At,Yt,Ct.width,Ct.height,0,Bt,qt,Ct.data)}else if(E.isDataArrayTexture)if(G){if(Lt&&i.texStorage3D(s.TEXTURE_2D_ARRAY,zt,Yt,xt.width,xt.height,xt.depth),Et)if(E.layerUpdates.size>0){const At=P_(xt.width,xt.height,E.format,E.type);for(const gt of E.layerUpdates){const Ft=xt.data.subarray(gt*At/xt.data.BYTES_PER_ELEMENT,(gt+1)*At/xt.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,gt,xt.width,xt.height,1,Bt,qt,Ft)}E.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,xt.width,xt.height,xt.depth,Bt,qt,xt.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,Yt,xt.width,xt.height,xt.depth,0,Bt,qt,xt.data);else if(E.isData3DTexture)G?(Lt&&i.texStorage3D(s.TEXTURE_3D,zt,Yt,xt.width,xt.height,xt.depth),Et&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,xt.width,xt.height,xt.depth,Bt,qt,xt.data)):i.texImage3D(s.TEXTURE_3D,0,Yt,xt.width,xt.height,xt.depth,0,Bt,qt,xt.data);else if(E.isFramebufferTexture){if(Lt)if(G)i.texStorage2D(s.TEXTURE_2D,zt,Yt,xt.width,xt.height);else{let At=xt.width,gt=xt.height;for(let Ft=0;Ft<zt;Ft++)i.texImage2D(s.TEXTURE_2D,Ft,Yt,At,gt,0,Bt,qt,null),At>>=1,gt>>=1}}else if(ie.length>0){if(G&&Lt){const At=Ke(ie[0]);i.texStorage2D(s.TEXTURE_2D,zt,Yt,At.width,At.height)}for(let At=0,gt=ie.length;At<gt;At++)Ct=ie[At],G?Et&&i.texSubImage2D(s.TEXTURE_2D,At,0,0,Bt,qt,Ct):i.texImage2D(s.TEXTURE_2D,At,Yt,Bt,qt,Ct);E.generateMipmaps=!1}else if(G){if(Lt){const At=Ke(xt);i.texStorage2D(s.TEXTURE_2D,zt,Yt,At.width,At.height)}Et&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,Bt,qt,xt)}else i.texImage2D(s.TEXTURE_2D,0,Yt,Bt,qt,xt);y(E)&&_(ft),Pt.__version=ot.version,E.onUpdate&&E.onUpdate(E)}L.__version=E.version}function Rt(L,E,tt){if(E.image.length!==6)return;const ft=St(L,E),dt=E.source;i.bindTexture(s.TEXTURE_CUBE_MAP,L.__webglTexture,s.TEXTURE0+tt);const ot=r.get(dt);if(dt.version!==ot.__version||ft===!0){i.activeTexture(s.TEXTURE0+tt);const Pt=be.getPrimaries(be.workingColorSpace),Ut=E.colorSpace===za?null:be.getPrimaries(E.colorSpace),Gt=E.colorSpace===za||Pt===Ut?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Gt);const kt=E.isCompressedTexture||E.image[0].isCompressedTexture,xt=E.image[0]&&E.image[0].isDataTexture,Bt=[];for(let gt=0;gt<6;gt++)!kt&&!xt?Bt[gt]=C(E.image[gt],!0,l.maxCubemapSize):Bt[gt]=xt?E.image[gt].image:E.image[gt],Bt[gt]=ae(E,Bt[gt]);const qt=Bt[0],Yt=u.convert(E.format,E.colorSpace),Ct=u.convert(E.type),ie=N(E.internalFormat,Yt,Ct,E.colorSpace),G=E.isVideoTexture!==!0,Lt=ot.__version===void 0||ft===!0,Et=dt.dataReady;let zt=V(E,qt);vt(s.TEXTURE_CUBE_MAP,E);let At;if(kt){G&&Lt&&i.texStorage2D(s.TEXTURE_CUBE_MAP,zt,ie,qt.width,qt.height);for(let gt=0;gt<6;gt++){At=Bt[gt].mipmaps;for(let Ft=0;Ft<At.length;Ft++){const ne=At[Ft];E.format!==mi?Yt!==null?G?Et&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Ft,0,0,ne.width,ne.height,Yt,ne.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Ft,ie,ne.width,ne.height,0,ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):G?Et&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Ft,0,0,ne.width,ne.height,Yt,Ct,ne.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Ft,ie,ne.width,ne.height,0,Yt,Ct,ne.data)}}}else{if(At=E.mipmaps,G&&Lt){At.length>0&&zt++;const gt=Ke(Bt[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,zt,ie,gt.width,gt.height)}for(let gt=0;gt<6;gt++)if(xt){G?Et&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,0,0,Bt[gt].width,Bt[gt].height,Yt,Ct,Bt[gt].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,ie,Bt[gt].width,Bt[gt].height,0,Yt,Ct,Bt[gt].data);for(let Ft=0;Ft<At.length;Ft++){const Ce=At[Ft].image[gt].image;G?Et&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Ft+1,0,0,Ce.width,Ce.height,Yt,Ct,Ce.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Ft+1,ie,Ce.width,Ce.height,0,Yt,Ct,Ce.data)}}else{G?Et&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,0,0,Yt,Ct,Bt[gt]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,ie,Yt,Ct,Bt[gt]);for(let Ft=0;Ft<At.length;Ft++){const ne=At[Ft];G?Et&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Ft+1,0,0,Yt,Ct,ne.image[gt]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Ft+1,ie,Yt,Ct,ne.image[gt])}}}y(E)&&_(s.TEXTURE_CUBE_MAP),ot.__version=dt.version,E.onUpdate&&E.onUpdate(E)}L.__version=E.version}function wt(L,E,tt,ft,dt,ot){const Pt=u.convert(tt.format,tt.colorSpace),Ut=u.convert(tt.type),Gt=N(tt.internalFormat,Pt,Ut,tt.colorSpace),kt=r.get(E),xt=r.get(tt);if(xt.__renderTarget=E,!kt.__hasExternalTextures){const Bt=Math.max(1,E.width>>ot),qt=Math.max(1,E.height>>ot);dt===s.TEXTURE_3D||dt===s.TEXTURE_2D_ARRAY?i.texImage3D(dt,ot,Gt,Bt,qt,E.depth,0,Pt,Ut,null):i.texImage2D(dt,ot,Gt,Bt,qt,0,Pt,Ut,null)}i.bindFramebuffer(s.FRAMEBUFFER,L),ge(E)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ft,dt,xt.__webglTexture,0,Vt(E)):(dt===s.TEXTURE_2D||dt>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&dt<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,ft,dt,xt.__webglTexture,ot),i.bindFramebuffer(s.FRAMEBUFFER,null)}function oe(L,E,tt){if(s.bindRenderbuffer(s.RENDERBUFFER,L),E.depthBuffer){const ft=E.depthTexture,dt=ft&&ft.isDepthTexture?ft.type:null,ot=w(E.stencilBuffer,dt),Pt=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ut=Vt(E);ge(E)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ut,ot,E.width,E.height):tt?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ut,ot,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,ot,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Pt,s.RENDERBUFFER,L)}else{const ft=E.textures;for(let dt=0;dt<ft.length;dt++){const ot=ft[dt],Pt=u.convert(ot.format,ot.colorSpace),Ut=u.convert(ot.type),Gt=N(ot.internalFormat,Pt,Ut,ot.colorSpace),kt=Vt(E);tt&&ge(E)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,kt,Gt,E.width,E.height):ge(E)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,kt,Gt,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,Gt,E.width,E.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Qt(L,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(s.FRAMEBUFFER,L),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ft=r.get(E.depthTexture);ft.__renderTarget=E,(!ft.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),_t(E.depthTexture,0);const dt=ft.__webglTexture,ot=Vt(E);if(E.depthTexture.format===Lo)ge(E)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,dt,0,ot):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,dt,0);else if(E.depthTexture.format===No)ge(E)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,dt,0,ot):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,dt,0);else throw new Error("Unknown depthTexture format")}function Ue(L){const E=r.get(L),tt=L.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==L.depthTexture){const ft=L.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ft){const dt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ft.removeEventListener("dispose",dt)};ft.addEventListener("dispose",dt),E.__depthDisposeCallback=dt}E.__boundDepthTexture=ft}if(L.depthTexture&&!E.__autoAllocateDepthBuffer){if(tt)throw new Error("target.depthTexture not supported in Cube render targets");const ft=L.texture.mipmaps;ft&&ft.length>0?Qt(E.__webglFramebuffer[0],L):Qt(E.__webglFramebuffer,L)}else if(tt){E.__webglDepthbuffer=[];for(let ft=0;ft<6;ft++)if(i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[ft]),E.__webglDepthbuffer[ft]===void 0)E.__webglDepthbuffer[ft]=s.createRenderbuffer(),oe(E.__webglDepthbuffer[ft],L,!1);else{const dt=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ot=E.__webglDepthbuffer[ft];s.bindRenderbuffer(s.RENDERBUFFER,ot),s.framebufferRenderbuffer(s.FRAMEBUFFER,dt,s.RENDERBUFFER,ot)}}else{const ft=L.texture.mipmaps;if(ft&&ft.length>0?i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=s.createRenderbuffer(),oe(E.__webglDepthbuffer,L,!1);else{const dt=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ot=E.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,ot),s.framebufferRenderbuffer(s.FRAMEBUFFER,dt,s.RENDERBUFFER,ot)}}i.bindFramebuffer(s.FRAMEBUFFER,null)}function ze(L,E,tt){const ft=r.get(L);E!==void 0&&wt(ft.__webglFramebuffer,L,L.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),tt!==void 0&&Ue(L)}function me(L){const E=L.texture,tt=r.get(L),ft=r.get(E);L.addEventListener("dispose",H);const dt=L.textures,ot=L.isWebGLCubeRenderTarget===!0,Pt=dt.length>1;if(Pt||(ft.__webglTexture===void 0&&(ft.__webglTexture=s.createTexture()),ft.__version=E.version,h.memory.textures++),ot){tt.__webglFramebuffer=[];for(let Ut=0;Ut<6;Ut++)if(E.mipmaps&&E.mipmaps.length>0){tt.__webglFramebuffer[Ut]=[];for(let Gt=0;Gt<E.mipmaps.length;Gt++)tt.__webglFramebuffer[Ut][Gt]=s.createFramebuffer()}else tt.__webglFramebuffer[Ut]=s.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){tt.__webglFramebuffer=[];for(let Ut=0;Ut<E.mipmaps.length;Ut++)tt.__webglFramebuffer[Ut]=s.createFramebuffer()}else tt.__webglFramebuffer=s.createFramebuffer();if(Pt)for(let Ut=0,Gt=dt.length;Ut<Gt;Ut++){const kt=r.get(dt[Ut]);kt.__webglTexture===void 0&&(kt.__webglTexture=s.createTexture(),h.memory.textures++)}if(L.samples>0&&ge(L)===!1){tt.__webglMultisampledFramebuffer=s.createFramebuffer(),tt.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,tt.__webglMultisampledFramebuffer);for(let Ut=0;Ut<dt.length;Ut++){const Gt=dt[Ut];tt.__webglColorRenderbuffer[Ut]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,tt.__webglColorRenderbuffer[Ut]);const kt=u.convert(Gt.format,Gt.colorSpace),xt=u.convert(Gt.type),Bt=N(Gt.internalFormat,kt,xt,Gt.colorSpace,L.isXRRenderTarget===!0),qt=Vt(L);s.renderbufferStorageMultisample(s.RENDERBUFFER,qt,Bt,L.width,L.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ut,s.RENDERBUFFER,tt.__webglColorRenderbuffer[Ut])}s.bindRenderbuffer(s.RENDERBUFFER,null),L.depthBuffer&&(tt.__webglDepthRenderbuffer=s.createRenderbuffer(),oe(tt.__webglDepthRenderbuffer,L,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(ot){i.bindTexture(s.TEXTURE_CUBE_MAP,ft.__webglTexture),vt(s.TEXTURE_CUBE_MAP,E);for(let Ut=0;Ut<6;Ut++)if(E.mipmaps&&E.mipmaps.length>0)for(let Gt=0;Gt<E.mipmaps.length;Gt++)wt(tt.__webglFramebuffer[Ut][Gt],L,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,Gt);else wt(tt.__webglFramebuffer[Ut],L,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,0);y(E)&&_(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Pt){for(let Ut=0,Gt=dt.length;Ut<Gt;Ut++){const kt=dt[Ut],xt=r.get(kt);i.bindTexture(s.TEXTURE_2D,xt.__webglTexture),vt(s.TEXTURE_2D,kt),wt(tt.__webglFramebuffer,L,kt,s.COLOR_ATTACHMENT0+Ut,s.TEXTURE_2D,0),y(kt)&&_(s.TEXTURE_2D)}i.unbindTexture()}else{let Ut=s.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(Ut=L.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Ut,ft.__webglTexture),vt(Ut,E),E.mipmaps&&E.mipmaps.length>0)for(let Gt=0;Gt<E.mipmaps.length;Gt++)wt(tt.__webglFramebuffer[Gt],L,E,s.COLOR_ATTACHMENT0,Ut,Gt);else wt(tt.__webglFramebuffer,L,E,s.COLOR_ATTACHMENT0,Ut,0);y(E)&&_(Ut),i.unbindTexture()}L.depthBuffer&&Ue(L)}function z(L){const E=L.textures;for(let tt=0,ft=E.length;tt<ft;tt++){const dt=E[tt];if(y(dt)){const ot=B(L),Pt=r.get(dt).__webglTexture;i.bindTexture(ot,Pt),_(ot),i.unbindTexture()}}}const xn=[],ye=[];function he(L){if(L.samples>0){if(ge(L)===!1){const E=L.textures,tt=L.width,ft=L.height;let dt=s.COLOR_BUFFER_BIT;const ot=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Pt=r.get(L),Ut=E.length>1;if(Ut)for(let kt=0;kt<E.length;kt++)i.bindFramebuffer(s.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+kt,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,Pt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+kt,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer);const Gt=L.texture.mipmaps;Gt&&Gt.length>0?i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer[0]):i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer);for(let kt=0;kt<E.length;kt++){if(L.resolveDepthBuffer&&(L.depthBuffer&&(dt|=s.DEPTH_BUFFER_BIT),L.stencilBuffer&&L.resolveStencilBuffer&&(dt|=s.STENCIL_BUFFER_BIT)),Ut){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Pt.__webglColorRenderbuffer[kt]);const xt=r.get(E[kt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,xt,0)}s.blitFramebuffer(0,0,tt,ft,0,0,tt,ft,dt,s.NEAREST),p===!0&&(xn.length=0,ye.length=0,xn.push(s.COLOR_ATTACHMENT0+kt),L.depthBuffer&&L.resolveDepthBuffer===!1&&(xn.push(ot),ye.push(ot),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,ye)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,xn))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Ut)for(let kt=0;kt<E.length;kt++){i.bindFramebuffer(s.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+kt,s.RENDERBUFFER,Pt.__webglColorRenderbuffer[kt]);const xt=r.get(E[kt]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,Pt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+kt,s.TEXTURE_2D,xt,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer)}else if(L.depthBuffer&&L.resolveDepthBuffer===!1&&p){const E=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[E])}}}function Vt(L){return Math.min(l.maxSamples,L.samples)}function ge(L){const E=r.get(L);return L.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function jt(L){const E=h.render.frame;g.get(L)!==E&&(g.set(L,E),L.update())}function ae(L,E){const tt=L.colorSpace,ft=L.format,dt=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||tt!==Ms&&tt!==za&&(be.getTransfer(tt)===Pe?(ft!==mi||dt!==ia)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",tt)),E}function Ke(L){return typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement?(m.width=L.naturalWidth||L.width,m.height=L.naturalHeight||L.height):typeof VideoFrame<"u"&&L instanceof VideoFrame?(m.width=L.displayWidth,m.height=L.displayHeight):(m.width=L.width,m.height=L.height),m}this.allocateTextureUnit=st,this.resetTextureUnits=lt,this.setTexture2D=_t,this.setTexture2DArray=O,this.setTexture3D=$,this.setTextureCube=q,this.rebindTextures=ze,this.setupRenderTarget=me,this.updateRenderTargetMipmap=z,this.updateMultisampleRenderTarget=he,this.setupDepthRenderbuffer=Ue,this.setupFrameBufferTexture=wt,this.useMultisampledRTT=ge}function RA(s,e){function i(r,l=za){let u;const h=be.getTransfer(l);if(r===ia)return s.UNSIGNED_BYTE;if(r===ud)return s.UNSIGNED_SHORT_4_4_4_4;if(r===fd)return s.UNSIGNED_SHORT_5_5_5_1;if(r===v0)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===g0)return s.BYTE;if(r===_0)return s.SHORT;if(r===Do)return s.UNSIGNED_SHORT;if(r===cd)return s.INT;if(r===Sr)return s.UNSIGNED_INT;if(r===ta)return s.FLOAT;if(r===Oo)return s.HALF_FLOAT;if(r===x0)return s.ALPHA;if(r===S0)return s.RGB;if(r===mi)return s.RGBA;if(r===Lo)return s.DEPTH_COMPONENT;if(r===No)return s.DEPTH_STENCIL;if(r===y0)return s.RED;if(r===hd)return s.RED_INTEGER;if(r===M0)return s.RG;if(r===dd)return s.RG_INTEGER;if(r===pd)return s.RGBA_INTEGER;if(r===gc||r===_c||r===vc||r===xc)if(h===Pe)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===gc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===_c)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===vc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===xc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===gc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===_c)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===vc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===xc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Lh||r===Nh||r===Oh||r===Ph)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Lh)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Nh)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Oh)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Ph)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Bh||r===zh||r===Ih)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===Bh||r===zh)return h===Pe?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===Ih)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Fh||r===Hh||r===Gh||r===Vh||r===kh||r===Xh||r===Wh||r===qh||r===Yh||r===jh||r===Zh||r===Kh||r===Qh||r===Jh)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===Fh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Hh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Gh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Vh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===kh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Xh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Wh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===qh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Yh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===jh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Zh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===Kh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===Qh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===Jh)return h===Pe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Sc||r===$h||r===td)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===Sc)return h===Pe?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===$h)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===td)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===E0||r===ed||r===nd||r===id)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===Sc)return u.COMPRESSED_RED_RGTC1_EXT;if(r===ed)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===nd)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===id)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Uo?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:i}}const CA=`
void main() {
...
}`;class DA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i,r){if(this.texture===null){const l=new Hn,u=e.properties.get(l);u.__webglTexture=i.texture,(i.depthNear!==r.depthNear||i.depthFar!==r.depthFar)&&(this.depthNear=i.depthNear,this.depthFar=i.depthFar),this.texture=l}}getMesh(e){if(this.texture!==null&&this.mesh===null){const i=e.cameras[0].viewport,r=new Ga({vertexShader:CA,fragmentShader:wA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Ai(new Dc(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class UA extends Ts{constructor(e,i){super();const r=this;let l=null,u=1,h=null,d="local-floor",p=1,m=null,g=null,v=null,x=null,M=null,A=null;const C=new DA,y=i.getContextAttributes();let _=null,B=null;const N=[],w=[],V=new He;let I=null;const H=new oi;H.viewport=new $e;const j=new oi;j.viewport=new $e;const D=[H,j],R=new Jy;let k=null,lt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let pt=N[K];return pt===void 0&&(pt=new uh,N[K]=pt),pt.getTargetRaySpace()},this.getControllerGrip=function(K){let pt=N[K];return pt===void 0&&(pt=new uh,N[K]=pt),pt.getGripSpace()},this.getHand=function(K){let pt=N[K];return pt===void 0&&(pt=new uh,N[K]=pt),pt.getHandSpace()};function st(K){const pt=w.indexOf(K.inputSource);if(pt===-1)return;const yt=N[pt];yt!==void 0&&(yt.update(K.inputSource,K.frame,m||h),yt.dispatchEvent({type:K.type,data:K.inputSource}))}function ut(){l.removeEventListener("select",st),l.removeEventListener("selectstart",st),l.removeEventListener("selectend",st),l.removeEventListener("squeeze",st),l.removeEventListener("squeezestart",st),l.removeEventListener("squeezeend",st),l.removeEventListener("end",ut),l.removeEventListener("inputsourceschange",_t);for(let K=0;K<N.length;K++){const pt=w[K];pt!==null&&(w[K]=null,N[K].disconnect(pt))}k=null,lt=null,C.reset(),e.setRenderTarget(_),M=null,x=null,v=null,l=null,B=null,St.stop(),r.isPresenting=!1,e.setPixelRatio(I),e.setSize(V.width,V.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){u=K,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){d=K,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return m||h},this.setReferenceSpace=function(K){m=K},this.getBaseLayer=function(){return x!==null?x:M},this.getBinding=function(){return v},this.getFrame=function(){return A},this.getSession=function(){return l},this.setSession=async function(K){if(l=K,l!==null){if(_=e.getRenderTarget(),l.addEventListener("select",st),l.addEventListener("selectstart",st),l.addEventListener("selectend",st),l.addEventListener("squeeze",st),l.addEventListener("squeezestart",st),l.addEventListener("squeezeend",st),l.addEventListener("end",ut),l.addEventListener("inputsourceschange",_t),y.xrCompatible!==!0&&await i.makeXRCompatible(),I=e.getPixelRatio(),e.getSize(V),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let yt=null,Rt=null,wt=null;y.depth&&(wt=y.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,yt=y.stencil?No:Lo,Rt=y.stencil?Uo:Sr);const oe={colorFormat:i.RGBA8,depthFormat:wt,scaleFactor:u};v=new XRWebGLBinding(l,i),x=v.createProjectionLayer(oe),l.updateRenderState({layers:[x]}),e.setPixelRatio(1),e.setSize(x.textureWidth,x.textureHeight,!1),B=new yr(x.textureWidth,x.textureHeight,{format:mi,type:ia,depthTexture:new P0(x.textureWidth,x.textureHeight,Rt,void 0,void 0,void 0,void 0,void 0,void 0,yt),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}else{const yt={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:u};M=new XRWebGLLayer(l,i,yt),l.updateRenderState({baseLayer:M}),e.setPixelRatio(1),e.setSize(M.framebufferWidth,M.framebufferHeight,!1),B=new yr(M.framebufferWidth,M.framebufferHeight,{format:mi,type:ia,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:M.ignoreDepthValues===!1,resolveStencilBuffer:M.ignoreDepthValues===!1})}B.isXRRenderTarget=!0,this.setFoveation(p),m=null,h=await l.requestReferenceSpace(d),St.setContext(l),St.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return C.getDepthTexture()};function _t(K){for(let pt=0;pt<K.removed.length;pt++){const yt=K.removed[pt],Rt=w.indexOf(yt);Rt>=0&&(w[Rt]=null,N[Rt].disconnect(yt))}for(let pt=0;pt<K.added.length;pt++){const yt=K.added[pt];let Rt=w.indexOf(yt);if(Rt===-1){for(let oe=0;oe<N.length;oe++)if(oe>=w.length){w.push(yt),Rt=oe;break}else if(w[oe]===null){w[oe]=yt,Rt=oe;break}if(Rt===-1)break}const wt=N[Rt];wt&&wt.connect(yt)}}const O=new rt,$=new rt;function q(K,pt,yt){O.setFromMatrixPosition(pt.matrixWorld),$.setFromMatrixPosition(yt.matrixWorld);const Rt=O.distanceTo($),wt=pt.projectionMatrix.elements,oe=yt.projectionMatrix.elements,Qt=wt[14]/(wt[10]-1),Ue=wt[14]/(wt[10]+1),ze=(wt[9]+1)/wt[5],me=(wt[9]-1)/wt[5],z=(wt[8]-1)/wt[0],xn=(oe[8]+1)/oe[0],ye=Qt*z,he=Qt*xn,Vt=Rt/(-z+xn),ge=Vt*-z;if(pt.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(ge),K.translateZ(Vt),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),wt[10]===-1)K.projectionMatrix.copy(pt.projectionMatrix),K.projectionMatrixInverse.copy(pt.projectionMatrixInverse);else{const jt=Qt+Vt,ae=Ue+Vt,Ke=ye-ge,L=he+(Rt-ge),E=ze*Ue/ae*jt,tt=me*Ue/ae*jt;K.projectionMatrix.makePerspective(Ke,L,E,tt,jt,ae),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function Mt(K,pt){pt===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(pt.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(l===null)return;let pt=K.near,yt=K.far;C.texture!==null&&(C.depthNear>0&&(pt=C.depthNear),C.depthFar>0&&(yt=C.depthFar)),R.near=j.near=H.near=pt,R.far=j.far=H.far=yt,(k!==R.near||lt!==R.far)&&(l.updateRenderState({depthNear:R.near,depthFar:R.far}),k=R.near,lt=R.far),H.layers.mask=K.layers.mask|2,j.layers.mask=K.layers.mask|4,R.layers.mask=H.layers.mask|j.layers.mask;const Rt=K.parent,wt=R.cameras;Mt(R,Rt);for(let oe=0;oe<wt.length;oe++)Mt(wt[oe],Rt);wt.length===2?q(R,H,j):R.projectionMatrix.copy(H.projectionMatrix),U(K,R,Rt)};function U(K,pt,yt){yt===null?K.matrix.copy(pt.matrixWorld):(K.matrix.copy(yt.matrixWorld),K.matrix.invert(),K.matrix.multiply(pt.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(pt.projectionMatrix),K.projectionMatrixInverse.copy(pt.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=ad*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(x===null&&M===null))return p},this.setFoveation=function(K){p=K,x!==null&&(x.fixedFoveation=K),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=K)},this.hasDepthSensing=function(){return C.texture!==null},this.getDepthSensingMesh=function(){return C.getMesh(R)};let J=null;function vt(K,pt){if(g=pt.getViewerPose(m||h),A=pt,g!==null){const yt=g.views;M!==null&&(e.setRenderTargetFramebuffer(B,M.framebuffer),e.setRenderTarget(B));let Rt=!1;yt.length!==R.cameras.length&&(R.cameras.length=0,Rt=!0);for(let Qt=0;Qt<yt.length;Qt++){const Ue=yt[Qt];let ze=null;if(M!==null)ze=M.getViewport(Ue);else{const z=v.getViewSubImage(x,Ue);ze=z.viewport,Qt===0&&(e.setRenderTargetTextures(B,z.colorTexture,z.depthStencilTexture),e.setRenderTarget(B))}let me=D[Qt];me===void 0&&(me=new oi,me.layers.enable(Qt),me.viewport=new $e,D[Qt]=me),me.matrix.fromArray(Ue.transform.matrix),me.matrix.decompose(me.position,me.quaternion,me.scale),me.projectionMatrix.fromArray(Ue.projectionMatrix),me.projectionMatrixInverse.copy(me.projectionMatrix).invert(),me.viewport.set(ze.x,ze.y,ze.width,ze.height),Qt===0&&(R.matrix.copy(me.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),Rt===!0&&R.cameras.push(me)}const wt=l.enabledFeatures;if(wt&&wt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&v){const Qt=v.getDepthInformation(yt[0]);Qt&&Qt.isValid&&Qt.texture&&C.init(e,Qt,l.renderState)}}for(let yt=0;yt<N.length;yt++){const Rt=w[yt],wt=N[yt];Rt!==null&&wt!==void 0&&wt.update(Rt,pt,m||h)}J&&J(K,pt),pt.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:pt}),A=null}const St=new B0;St.setAnimationLoop(vt),this.setAnimationLoop=function(K){J=K},this.dispose=function(){}}}const hr=new aa,LA=new rn;function NA(s,e){function i(y,_){y.matrixAutoUpdate===!0&&y.updateMatrix(),_.value.copy(y.matrix)}function r(y,_){_.color.getRGB(y.fogColor.value,U0(s)),_.isFog?(y.fogNear.value=_.near,y.fogFar.value=_.far):_.isFogExp2&&(y.fogDensity.value=_.density)}function l(y,_,B,N,w){_.isMeshBasicMaterial||_.isMeshLambertMaterial?u(y,_):_.isMeshToonMaterial?(u(y,_),v(y,_)):_.isMeshPhongMaterial?(u(y,_),g(y,_)):_.isMeshStandardMaterial?(u(y,_),x(y,_),_.isMeshPhysicalMaterial&&M(y,_,w)):_.isMeshMatcapMaterial?(u(y,_),A(y,_)):_.isMeshDepthMaterial?u(y,_):_.isMeshDistanceMaterial?(u(y,_),C(y,_)):_.isMeshNormalMaterial?u(y,_):_.isLineBasicMaterial?(h(y,_),_.isLineDashedMaterial&&d(y,_)):_.isPointsMaterial?p(y,_,B,N):_.isSpriteMaterial?m(y,_):_.isShadowMaterial?(y.color.value.copy(_.color),y.opacity.value=_.opacity):_.isShaderMaterial&&(_.uniformsNeedUpdate=!1)}function u(y,_){y.opacity.value=_.opacity,_.color&&y.diffuse.value.copy(_.color),_.emissive&&y.emissive.value.copy(_.emissive).multiplyScalar(_.emissiveIntensity),_.map&&(y.map.value=_.map,i(_.map,y.mapTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,i(_.alphaMap,y.alphaMapTransform)),_.bumpMap&&(y.bumpMap.value=_.bumpMap,i(_.bumpMap,y.bumpMapTransform),y.bumpScale.value=_.bumpScale,_.side===Fn&&(y.bumpScale.value*=-1)),_.normalMap&&(y.normalMap.value=_.normalMap,i(_.normalMap,y.normalMapTransform),y.normalScale.value.copy(_.normalScale),_.side===Fn&&y.normalScale.value.negate()),_.displacementMap&&(y.displacementMap.value=_.displacementMap,i(_.displacementMap,y.displacementMapTransform),y.displacementScale.value=_.displacementScale,y.displacementBias.value=_.displacementBias),_.emissiveMap&&(y.emissiveMap.value=_.emissiveMap,i(_.emissiveMap,y.emissiveMapTransform)),_.specularMap&&(y.specularMap.value=_.specularMap,i(_.specularMap,y.specularMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest);const B=e.get(_),N=B.envMap,w=B.envMapRotation;N&&(y.envMap.value=N,hr.copy(w),hr.x*=-1,hr.y*=-1,hr.z*=-1,N.isCubeTexture&&N.isRenderTargetTexture===!1&&(hr.y*=-1,hr.z*=-1),y.envMapRotation.value.setFromMatrix4(LA.makeRotationFromEuler(hr)),y.flipEnvMap.value=N.isCubeTexture&&N.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=_.reflectivity,y.ior.value=_.ior,y.refractionRatio.value=_.refractionRatio),_.lightMap&&(y.lightMap.value=_.lightMap,y.lightMapIntensity.value=_.lightMapIntensity,i(_.lightMap,y.lightMapTransform)),_.aoMap&&(y.aoMap.value=_.aoMap,y.aoMapIntensity.value=_.aoMapIntensity,i(_.aoMap,y.aoMapTransform))}function h(y,_){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,_.map&&(y.map.value=_.map,i(_.map,y.mapTransform))}function d(y,_){y.dashSize.value=_.dashSize,y.totalSize.value=_.dashSize+_.gapSize,y.scale.value=_.scale}function p(y,_,B,N){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,y.size.value=_.size*B,y.scale.value=N*.5,_.map&&(y.map.value=_.map,i(_.map,y.uvTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,i(_.alphaMap,y.alphaMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest)}function m(y,_){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,y.rotation.value=_.rotation,_.map&&(y.map.value=_.map,i(_.map,y.mapTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,i(_.alphaMap,y.alphaMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest)}function g(y,_){y.specular.value.copy(_.specular),y.shininess.value=Math.max(_.shininess,1e-4)}function v(y,_){_.gradientMap&&(y.gradientMap.value=_.gradientMap)}function x(y,_){y.metalness.value=_.metalness,_.metalnessMap&&(y.metalnessMap.value=_.metalnessMap,i(_.metalnessMap,y.metalnessMapTransform)),y.roughness.value=_.roughness,_.roughnessMap&&(y.roughnessMap.value=_.roughnessMap,i(_.roughnessMap,y.roughnessMapTransform)),_.envMap&&(y.envMapIntensity.value=_.envMapIntensity)}function M(y,_,B){y.ior.value=_.ior,_.sheen>0&&(y.sheenColor.value.copy(_.sheenColor).multiplyScalar(_.sheen),y.sheenRoughness.value=_.sheenRoughness,_.sheenColorMap&&(y.sheenColorMap.value=_.sheenColorMap,i(_.sheenColorMap,y.sheenColorMapTransform)),_.sheenRoughnessMap&&(y.sheenRoughnessMap.value=_.sheenRoughnessMap,i(_.sheenRoughnessMap,y.sheenRoughnessMapTransform))),_.clearcoat>0&&(y.clearcoat.value=_.clearcoat,y.clearcoatRoughness.value=_.clearcoatRoughness,_.clearcoatMap&&(y.clearcoatMap.value=_.clearcoatMap,i(_.clearcoatMap,y.clearcoatMapTransform)),_.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=_.clearcoatRoughnessMap,i(_.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),_.clearcoatNormalMap&&(y.clearcoatNormalMap.value=_.clearcoatNormalMap,i(_.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(_.clearcoatNormalScale),_.side===Fn&&y.clearcoatNormalScale.value.negate())),_.dispersion>0&&(y.dispersion.value=_.dispersion),_.iridescence>0&&(y.iridescence.value=_.iridescence,y.iridescenceIOR.value=_.iridescenceIOR,y.iridescenceThicknessMinimum.value=_.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=_.iridescenceThicknessRange[1],_.iridescenceMap&&(y.iridescenceMap.value=_.iridescenceMap,i(_.iridescenceMap,y.iridescenceMapTransform)),_.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=_.iridescenceThicknessMap,i(_.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),_.transmission>0&&(y.transmission.value=_.transmission,y.transmissionSamplerMap.value=B.texture,y.transmissionSamplerSize.value.set(B.width,B.height),_.transmissionMap&&(y.transmissionMap.value=_.transmissionMap,i(_.transmissionMap,y.transmissionMapTransform)),y.thickness.value=_.thickness,_.thicknessMap&&(y.thicknessMap.value=_.thicknessMap,i(_.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=_.attenuationDistance,y.attenuationColor.value.copy(_.attenuationColor)),_.anisotropy>0&&(y.anisotropyVector.value.set(_.anisotropy*Math.cos(_.anisotropyRotation),_.anisotropy*Math.sin(_.anisotropyRotation)),_.anisotropyMap&&(y.anisotropyMap.value=_.anisotropyMap,i(_.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=_.specularIntensity,y.specularColor.value.copy(_.specularColor),_.specularColorMap&&(y.specularColorMap.value=_.specularColorMap,i(_.specularColorMap,y.specularColorMapTransform)),_.specularIntensityMap&&(y.specularIntensityMap.value=_.specularIntensityMap,i(_.specularIntensityMap,y.specularIntensityMapTransform))}function A(y,_){_.matcap&&(y.matcap.value=_.matcap)}function C(y,_){const B=e.get(_).light;y.referencePosition.value.setFromMatrixPosition(B.matrixWorld),y.nearDistance.value=B.shadow.camera.near,y.farDistance.value=B.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function OA(s,e,i,r){let l={},u={},h=[];const d=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function p(B,N){const w=N.program;r.uniformBlockBinding(B,w)}function m(B,N){let w=l[B.id];w===void 0&&(A(B),w=g(B),l[B.id]=w,B.addEventListener("dispose",y));const V=N.program;r.updateUBOMapping(B,V);const I=e.render.frame;u[B.id]!==I&&(x(B),u[B.id]=I)}function g(B){const N=v();B.__bindingPointIndex=N;const w=s.createBuffer(),V=B.__size,I=B.usage;return s.bindBuffer(s.UNIFORM_BUFFER,w),s.bufferData(s.UNIFORM_BUFFER,V,I),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,N,w),w}function v(){for(let B=0;B<d;B++)if(h.indexOf(B)===-1)return h.push(B),B;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(B){const N=l[B.id],w=B.uniforms,V=B.__cache;s.bindBuffer(s.UNIFORM_BUFFER,N);for(let I=0,H=w.length;I<H;I++){const j=Array.isArray(w[I])?w[I]:[w[I]];for(let D=0,R=j.length;D<R;D++){const k=j[D];if(M(k,I,D,V)===!0){const lt=k.__offset,st=Array.isArray(k.value)?k.value:[k.value];let ut=0;for(let _t=0;_t<st.length;_t++){const O=st[_t],$=C(O);typeof O=="number"||typeof O=="boolean"?(k.__data[0]=O,s.bufferSubData(s.UNIFORM_BUFFER,lt+ut,k.__data)):O.isMatrix3?(k.__data[0]=O.elements[0],k.__data[1]=O.elements[1],k.__data[2]=O.elements[2],k.__data[3]=0,k.__data[4]=O.elements[3],k.__data[5]=O.elements[4],k.__data[6]=O.elements[5],k.__data[7]=0,k.__data[8]=O.elements[6],k.__data[9]=O.elements[7],k.__data[10]=O.elements[8],k.__data[11]=0):(O.toArray(k.__data,ut),ut+=$.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,lt,k.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function M(B,N,w,V){const I=B.value,H=N+"_"+w;if(V[H]===void 0)return typeof I=="number"||typeof I=="boolean"?V[H]=I:V[H]=I.clone(),!0;{const j=V[H];if(typeof I=="number"||typeof I=="boolean"){if(j!==I)return V[H]=I,!0}else if(j.equals(I)===!1)return j.copy(I),!0}return!1}function A(B){const N=B.uniforms;let w=0;const V=16;for(let H=0,j=N.length;H<j;H++){const D=Array.isArray(N[H])?N[H]:[N[H]];for(let R=0,k=D.length;R<k;R++){const lt=D[R],st=Array.isArray(lt.value)?lt.value:[lt.value];for(let ut=0,_t=st.length;ut<_t;ut++){const O=st[ut],$=C(O),q=w%V,Mt=q%$.boundary,U=q+Mt;w+=Mt,U!==0&&V-U<$.storage&&(w+=V-U),lt.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),lt.__offset=w,w+=$.storage}}}const I=w%V;return I>0&&(w+=V-I),B.__size=w,B.__cache={},this}function C(B){const N={boundary:0,storage:0};return typeof B=="number"||typeof B=="boolean"?(N.boundary=4,N.storage=4):B.isVector2?(N.boundary=8,N.storage=8):B.isVector3||B.isColor?(N.boundary=16,N.storage=12):B.isVector4?(N.boundary=16,N.storage=16):B.isMatrix3?(N.boundary=48,N.storage=48):B.isMatrix4?(N.boundary=64,N.storage=64):B.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",B),N}function y(B){const N=B.target;N.removeEventListener("dispose",y);const w=h.indexOf(N.__bindingPointIndex);h.splice(w,1),s.deleteBuffer(l[N.id]),delete l[N.id],delete u[N.id]}function _(){for(const B in l)s.deleteBuffer(l[B]);h=[],l={},u={}}return{bind:p,update:m,dispose:_}}class PA{constructor(e={}){const{canvas:i=_y(),context:r=null,depth:l=!0,stencil:u=!1,alpha:h=!1,antialias:d=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:m=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:v=!1,reverseDepthBuffer:x=!1}=e;this.isWebGLRenderer=!0;let M;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");M=r.getContextAttributes().alpha}else M=h;const A=new Uint32Array(4),C=new Int32Array(4);let y=null,_=null;const B=[],N=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Fa,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const w=this;let V=!1;this._outputColorSpace=si;let I=0,H=0,j=null,D=-1,R=null;const k=new $e,lt=new $e;let st=null;const ut=new Be(0);let _t=0,O=i.width,$=i.height,q=1,Mt=null,U=null;const J=new $e(0,0,O,$),vt=new $e(0,0,O,$);let St=!1;const K=new O0;let pt=!1,yt=!1;const Rt=new rn,wt=new rn,oe=new rt,Qt=new $e,Ue={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ze=!1;function me(){return j===null?q:1}let z=r;function xn(b,W){return i.getContext(b,W)}try{const b={alpha:!0,depth:l,stencil:u,antialias:d,premultipliedAlpha:p,preserveDrawingBuffer:m,powerPreference:g,failIfMajorPerformanceCaveat:v};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${ld}`),i.addEventListener("webglcontextlost",zt,!1),i.addEventListener("webglcontextrestored",At,!1),i.addEventListener("webglcontextcreationerror",gt,!1),z===null){const W="webgl2";if(z=xn(W,b),z===null)throw xn(W)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let ye,he,Vt,ge,jt,ae,Ke,L,E,tt,ft,dt,ot,Pt,Ut,Gt,kt,xt,Bt,qt,Yt,Ct,ie,G;function Lt(){ye=new WT(z),ye.init(),Ct=new RA(z,ye),he=new IT(z,ye,e,Ct),Vt=new bA(z,ye),he.reverseDepthBuffer&&x&&Vt.buffers.depth.setReversed(!0),ge=new jT(z),jt=new hA,ae=new AA(z,ye,Vt,jt,he,Ct,ge),Ke=new HT(w),L=new XT(w),E=new tM(z),ie=new BT(z,E),tt=new qT(z,E,ge,ie),ft=new KT(z,tt,E,ge),Bt=new ZT(z,he,ae),Gt=new FT(jt),dt=new fA(w,Ke,L,ye,he,ie,Gt),ot=new NA(w,jt),Pt=new pA,Ut=new SA(ye),xt=new PT(w,Ke,L,Vt,ft,M,p),kt=new EA(w,ft,he),G=new OA(z,ge,he,Vt),qt=new zT(z,ye,ge),Yt=new YT(z,ye,ge),ge.programs=dt.programs,w.capabilities=he,w.extensions=ye,w.properties=jt,w.renderLists=Pt,w.shadowMap=kt,w.state=Vt,w.info=ge}Lt();const Et=new UA(w,z);this.xr=Et,this.getContext=function(){return z},this.getContextAttributes=function(){return z.getContextAttributes()},this.forceContextLoss=function(){const b=ye.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=ye.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return q},this.setPixelRatio=function(b){b!==void 0&&(q=b,this.setSize(O,$,!1))},this.getSize=function(b){return b.set(O,$)},this.setSize=function(b,W,it=!0){if(Et.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}O=b,$=W,i.width=Math.floor(b*q),i.height=Math.floor(W*q),it===!0&&(i.style.width=b+"px",i.style.height=W+"px"),this.setViewport(0,0,b,W)},this.getDrawingBufferSize=function(b){return b.set(O*q,$*q).floor()},this.setDrawingBufferSize=function(b,W,it){O=b,$=W,q=it,i.width=Math.floor(b*it),i.height=Math.floor(W*it),this.setViewport(0,0,b,W)},this.getCurrentViewport=function(b){return b.copy(k)},this.getViewport=function(b){return b.copy(J)},this.setViewport=function(b,W,it,at){b.isVector4?J.set(b.x,b.y,b.z,b.w):J.set(b,W,it,at),Vt.viewport(k.copy(J).multiplyScalar(q).round())},this.getScissor=function(b){return b.copy(vt)},this.setScissor=function(b,W,it,at){b.isVector4?vt.set(b.x,b.y,b.z,b.w):vt.set(b,W,it,at),Vt.scissor(lt.copy(vt).multiplyScalar(q).round())},this.getScissorTest=function(){return St},this.setScissorTest=function(b){Vt.setScissorTest(St=b)},this.setOpaqueSort=function(b){Mt=b},this.setTransparentSort=function(b){U=b},this.getClearColor=function(b){return b.copy(xt.getClearColor())},this.setClearColor=function(){xt.setClearColor(...arguments)},this.getClearAlpha=function(){return xt.getClearAlpha()},this.setClearAlpha=function(){xt.setClearAlpha(...arguments)},this.clear=function(b=!0,W=!0,it=!0){let at=0;if(b){let Y=!1;if(j!==null){const Tt=j.texture.format;Y=Tt===pd||Tt===dd||Tt===hd}if(Y){const Tt=j.texture.type,Dt=Tt===ia||Tt===Sr||Tt===Do||Tt===Uo||Tt===ud||Tt===fd,Ot=xt.getClearColor(),It=xt.getClearAlpha(),$t=Ot.r,Zt=Ot.g,Xt=Ot.b;Dt?(A[0]=$t,A[1]=Zt,A[2]=Xt,A[3]=It,z.clearBufferuiv(z.COLOR,0,A)):(C[0]=$t,C[1]=Zt,C[2]=Xt,C[3]=It,z.clearBufferiv(z.COLOR,0,C))}else at|=z.COLOR_BUFFER_BIT}W&&(at|=z.DEPTH_BUFFER_BIT),it&&(at|=z.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z.clear(at)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",zt,!1),i.removeEventListener("webglcontextrestored",At,!1),i.removeEventListener("webglcontextcreationerror",gt,!1),xt.dispose(),Pt.dispose(),Ut.dispose(),jt.dispose(),Ke.dispose(),L.dispose(),ft.dispose(),ie.dispose(),G.dispose(),dt.dispose(),Et.dispose(),Et.removeEventListener("sessionstart",sn),Et.removeEventListener("sessionend",Sn),Nn.stop()};function zt(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),V=!0}function At(){console.log("THREE.WebGLRenderer: Context Restored."),V=!1;const b=ge.autoReset,W=kt.enabled,it=kt.autoUpdate,at=kt.needsUpdate,Y=kt.type;Lt(),ge.autoReset=b,kt.enabled=W,kt.autoUpdate=it,kt.needsUpdate=at,kt.type=Y}function gt(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function Ft(b){const W=b.target;W.removeEventListener("dispose",Ft),ne(W)}function ne(b){Ce(b),jt.remove(b)}function Ce(b){const W=jt.get(b).programs;W!==void 0&&(W.forEach(function(it){dt.releaseProgram(it)}),b.isShaderMaterial&&dt.releaseShaderCache(b))}this.renderBufferDirect=function(b,W,it,at,Y,Tt){W===null&&(W=Ue);const Dt=Y.isMesh&&Y.matrixWorld.determinant()<0,Ot=Xa(b,W,it,at,Y);Vt.setMaterial(at,Dt);let It=it.index,$t=1;if(at.wireframe===!0){if(It=tt.getWireframeAttribute(it),It===void 0)return;$t=2}const Zt=it.drawRange,Xt=it.attributes.position;let ce=Zt.start*$t,Ae=(Zt.start+Zt.count)*$t;Tt!==null&&(ce=Math.max(ce,Tt.start*$t),Ae=Math.min(Ae,(Tt.start+Tt.count)*$t)),It!==null?(ce=Math.max(ce,0),Ae=Math.min(Ae,It.count)):Xt!=null&&(ce=Math.max(ce,0),Ae=Math.min(Ae,Xt.count));const Ge=Ae-ce;if(Ge<0||Ge===1/0)return;ie.setup(Y,at,Ot,it,It);let _e,ve=qt;if(It!==null&&(_e=E.get(It),ve=Yt,ve.setIndex(_e)),Y.isMesh)at.wireframe===!0?(Vt.setLineWidth(at.wireframeLinewidth*me()),ve.setMode(z.LINES)):ve.setMode(z.TRIANGLES);else if(Y.isLine){let Kt=at.linewidth;Kt===void 0&&(Kt=1),Vt.setLineWidth(Kt*me()),Y.isLineSegments?ve.setMode(z.LINES):Y.isLineLoop?ve.setMode(z.LINE_LOOP):ve.setMode(z.LINE_STRIP)}else Y.isPoints?ve.setMode(z.POINTS):Y.isSprite&&ve.setMode(z.TRIANGLES);if(Y.isBatchedMesh)if(Y._multiDrawInstances!==null)_s("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ve.renderMultiDrawInstances(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount,Y._multiDrawInstances);else if(ye.get("WEBGL_multi_draw"))ve.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else{const Kt=Y._multiDrawStarts,Ye=Y._multiDrawCounts,Me=Y._multiDrawCount,bn=It?E.get(It).bytesPerElement:1,la=jt.get(at).currentProgram.getUniforms();for(let Ve=0;Ve<Me;Ve++)la.setValue(z,"_gl_DrawID",Ve),ve.render(Kt[Ve]/bn,Ye[Ve])}else if(Y.isInstancedMesh)ve.renderInstances(ce,Ge,Y.count);else if(it.isInstancedBufferGeometry){const Kt=it._maxInstanceCount!==void 0?it._maxInstanceCount:1/0,Ye=Math.min(it.instanceCount,Kt);ve.renderInstances(ce,Ge,Ye)}else ve.render(ce,Ge)};function Ee(b,W,it){b.transparent===!0&&b.side===$i&&b.forceSinglePass===!1?(b.side=Fn,b.needsUpdate=!0,sa(b,W,it),b.side=Ha,b.needsUpdate=!0,sa(b,W,it),b.side=$i):sa(b,W,it)}this.compile=function(b,W,it=null){it===null&&(it=b),_=Ut.get(it),_.init(W),N.push(_),it.traverseVisible(function(Y){Y.isLight&&Y.layers.test(W.layers)&&(_.pushLight(Y),Y.castShadow&&_.pushShadow(Y))}),b!==it&&b.traverseVisible(function(Y){Y.isLight&&Y.layers.test(W.layers)&&(_.pushLight(Y),Y.castShadow&&_.pushShadow(Y))}),_.setupLights();const at=new Set;return b.traverse(function(Y){if(!(Y.isMesh||Y.isPoints||Y.isLine||Y.isSprite))return;const Tt=Y.material;if(Tt)if(Array.isArray(Tt))for(let Dt=0;Dt<Tt.length;Dt++){const Ot=Tt[Dt];Ee(Ot,it,Y),at.add(Ot)}else Ee(Tt,it,Y),at.add(Tt)}),_=N.pop(),at},this.compileAsync=function(b,W,it=null){const at=this.compile(b,W,it);return new Promise(Y=>{function Tt(){if(at.forEach(function(Dt){jt.get(Dt).currentProgram.isReady()&&at.delete(Dt)}),at.size===0){Y(b);return}setTimeout(Tt,10)}ye.get("KHR_parallel_shader_compile")!==null?Tt():setTimeout(Tt,10)})};let Gn=null;function hn(b){Gn&&Gn(b)}function sn(){Nn.stop()}function Sn(){Nn.start()}const Nn=new B0;Nn.setAnimationLoop(hn),typeof self<"u"&&Nn.setContext(self),this.setAnimationLoop=function(b){Gn=b,Et.setAnimationLoop(b),b===null?Nn.stop():Nn.start()},Et.addEventListener("sessionstart",sn),Et.addEventListener("sessionend",Sn),this.render=function(b,W){if(W!==void 0&&W.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(V===!0)return;if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),W.parent===null&&W.matrixWorldAutoUpdate===!0&&W.updateMatrixWorld(),Et.enabled===!0&&Et.isPresenting===!0&&(Et.cameraAutoUpdate===!0&&Et.updateCamera(W),W=Et.getCamera()),b.isScene===!0&&b.onBeforeRender(w,b,W,j),_=Ut.get(b,N.length),_.init(W),N.push(_),wt.multiplyMatrices(W.projectionMatrix,W.matrixWorldInverse),K.setFromProjectionMatrix(wt),yt=this.localClippingEnabled,pt=Gt.init(this.clippingPlanes,yt),y=Pt.get(b,B.length),y.init(),B.push(y),Et.enabled===!0&&Et.isPresenting===!0){const Tt=w.xr.getDepthSensingMesh();Tt!==null&&Va(Tt,W,-1/0,w.sortObjects)}Va(b,W,0,w.sortObjects),y.finish(),w.sortObjects===!0&&y.sort(Mt,U),ze=Et.enabled===!1||Et.isPresenting===!1||Et.hasDepthSensing()===!1,ze&&xt.addToRenderList(y,b),this.info.render.frame++,pt===!0&&Gt.beginShadows();const it=_.state.shadowsArray;kt.render(it,b,W),pt===!0&&Gt.endShadows(),this.info.autoReset===!0&&this.info.reset();const at=y.opaque,Y=y.transmissive;if(_.setupLights(),W.isArrayCamera){const Tt=W.cameras;if(Y.length>0)for(let Dt=0,Ot=Tt.length;Dt<Ot;Dt++){const It=Tt[Dt];Fo(at,Y,b,It)}ze&&xt.render(b);for(let Dt=0,Ot=Tt.length;Dt<Ot;Dt++){const It=Tt[Dt];Io(y,b,It,It.viewport)}}else Y.length>0&&Fo(at,Y,b,W),ze&&xt.render(b),Io(y,b,W);j!==null&&H===0&&(ae.updateMultisampleRenderTarget(j),ae.updateRenderTargetMipmap(j)),b.isScene===!0&&b.onAfterRender(w,b,W),ie.resetDefaultState(),D=-1,R=null,N.pop(),N.length>0?(_=N[N.length-1],pt===!0&&Gt.setGlobalState(w.clippingPlanes,_.state.camera)):_=null,B.pop(),B.length>0?y=B[B.length-1]:y=null};function Va(b,W,it,at){if(b.visible===!1)return;if(b.layers.test(W.layers)){if(b.isGroup)it=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(W);else if(b.isLight)_.pushLight(b),b.castShadow&&_.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||K.intersectsSprite(b)){at&&Qt.setFromMatrixPosition(b.matrixWorld).applyMatrix4(wt);const Dt=ft.update(b),Ot=b.material;Ot.visible&&y.push(b,Dt,Ot,it,Qt.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||K.intersectsObject(b))){const Dt=ft.update(b),Ot=b.material;if(at&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),Qt.copy(b.boundingSphere.center)):(Dt.boundingSphere===null&&Dt.computeBoundingSphere(),Qt.copy(Dt.boundingSphere.center)),Qt.applyMatrix4(b.matrixWorld).applyMatrix4(wt)),Array.isArray(Ot)){const It=Dt.groups;for(let $t=0,Zt=It.length;$t<Zt;$t++){const Xt=It[$t],ce=Ot[Xt.materialIndex];ce&&ce.visible&&y.push(b,Dt,ce,it,Qt.z,Xt)}}else Ot.visible&&y.push(b,Dt,Ot,it,Qt.z,null)}}const Tt=b.children;for(let Dt=0,Ot=Tt.length;Dt<Ot;Dt++)Va(Tt[Dt],W,it,at)}function Io(b,W,it,at){const Y=b.opaque,Tt=b.transmissive,Dt=b.transparent;_.setupLightsView(it),pt===!0&&Gt.setGlobalState(w.clippingPlanes,it),at&&Vt.viewport(k.copy(at)),Y.length>0&&ka(Y,W,it),Tt.length>0&&ka(Tt,W,it),Dt.length>0&&ka(Dt,W,it),Vt.buffers.depth.setTest(!0),Vt.buffers.depth.setMask(!0),Vt.buffers.color.setMask(!0),Vt.setPolygonOffset(!1)}function Fo(b,W,it,at){if((it.isScene===!0?it.overrideMaterial:null)!==null)return;_.state.transmissionRenderTarget[at.id]===void 0&&(_.state.transmissionRenderTarget[at.id]=new yr(1,1,{generateMipmaps:!0,type:ye.has("EXT_color_buffer_half_float")||ye.has("EXT_color_buffer_float")?Oo:ia,minFilter:vr,samples:4,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:be.workingColorSpace}));const Tt=_.state.transmissionRenderTarget[at.id],Dt=at.viewport||k;Tt.setSize(Dt.z*w.transmissionResolutionScale,Dt.w*w.transmissionResolutionScale);const Ot=w.getRenderTarget();w.setRenderTarget(Tt),w.getClearColor(ut),_t=w.getClearAlpha(),_t<1&&w.setClearColor(16777215,.5),w.clear(),ze&&xt.render(it);const It=w.toneMapping;w.toneMapping=Fa;const $t=at.viewport;if(at.viewport!==void 0&&(at.viewport=void 0),_.setupLightsView(at),pt===!0&&Gt.setGlobalState(w.clippingPlanes,at),ka(b,it,at),ae.updateMultisampleRenderTarget(Tt),ae.updateRenderTargetMipmap(Tt),ye.has("WEBGL_multisampled_render_to_texture")===!1){let Zt=!1;for(let Xt=0,ce=W.length;Xt<ce;Xt++){const Ae=W[Xt],Ge=Ae.object,_e=Ae.geometry,ve=Ae.material,Kt=Ae.group;if(ve.side===$i&&Ge.layers.test(at.layers)){const Ye=ve.side;ve.side=Fn,ve.needsUpdate=!0,ra(Ge,it,at,_e,ve,Kt),ve.side=Ye,ve.needsUpdate=!0,Zt=!0}}Zt===!0&&(ae.updateMultisampleRenderTarget(Tt),ae.updateRenderTargetMipmap(Tt))}w.setRenderTarget(Ot),w.setClearColor(ut,_t),$t!==void 0&&(at.viewport=$t),w.toneMapping=It}function ka(b,W,it){const at=W.isScene===!0?W.overrideMaterial:null;for(let Y=0,Tt=b.length;Y<Tt;Y++){const Dt=b[Y],Ot=Dt.object,It=Dt.geometry,$t=Dt.group;let Zt=Dt.material;Zt.allowOverride===!0&&at!==null&&(Zt=at),Ot.layers.test(it.layers)&&ra(Ot,W,it,It,Zt,$t)}}function ra(b,W,it,at,Y,Tt){b.onBeforeRender(w,W,it,at,Y,Tt),b.modelViewMatrix.multiplyMatrices(it.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),Y.onBeforeRender(w,W,it,at,b,Tt),Y.transparent===!0&&Y.side===$i&&Y.forceSinglePass===!1?(Y.side=Fn,Y.needsUpdate=!0,w.renderBufferDirect(it,W,at,Y,b,Tt),Y.side=Ha,Y.needsUpdate=!0,w.renderBufferDirect(it,W,at,Y,b,Tt),Y.side=$i):w.renderBufferDirect(it,W,at,Y,b,Tt),b.onAfterRender(w,W,it,at,Y,Tt)}function sa(b,W,it){W.isScene!==!0&&(W=Ue);const at=jt.get(b),Y=_.state.lights,Tt=_.state.shadowsArray,Dt=Y.state.version,Ot=dt.getParameters(b,Y.state,Tt,W,it),It=dt.getProgramCacheKey(Ot);let $t=at.programs;at.environment=b.isMeshStandardMaterial?W.environment:null,at.fog=W.fog,at.envMap=(b.isMeshStandardMaterial?L:Ke).get(b.envMap||at.environment),at.envMapRotation=at.environment!==null&&b.envMap===null?W.environmentRotation:b.envMapRotation,$t===void 0&&(b.addEventListener("dispose",Ft),$t=new Map,at.programs=$t);let Zt=$t.get(It);if(Zt!==void 0){if(at.currentProgram===Zt&&at.lightsStateVersion===Dt)return wi(b,Ot),Zt}else Ot.uniforms=dt.getUniforms(b),b.onBeforeCompile(Ot,w),Zt=dt.acquireProgram(Ot,It),$t.set(It,Zt),at.uniforms=Ot.uniforms;const Xt=at.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Xt.clippingPlanes=Gt.uniform),wi(b,Ot),at.needsLights=tn(b),at.lightsStateVersion=Dt,at.needsLights&&(Xt.ambientLightColor.value=Y.state.ambient,Xt.lightProbe.value=Y.state.probe,Xt.directionalLights.value=Y.state.directional,Xt.directionalLightShadows.value=Y.state.directionalShadow,Xt.spotLights.value=Y.state.spot,Xt.spotLightShadows.value=Y.state.spotShadow,Xt.rectAreaLights.value=Y.state.rectArea,Xt.ltc_1.value=Y.state.rectAreaLTC1,Xt.ltc_2.value=Y.state.rectAreaLTC2,Xt.pointLights.value=Y.state.point,Xt.pointLightShadows.value=Y.state.pointShadow,Xt.hemisphereLights.value=Y.state.hemi,Xt.directionalShadowMap.value=Y.state.directionalShadowMap,Xt.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,Xt.spotShadowMap.value=Y.state.spotShadowMap,Xt.spotLightMatrix.value=Y.state.spotLightMatrix,Xt.spotLightMap.value=Y.state.spotLightMap,Xt.pointShadowMap.value=Y.state.pointShadowMap,Xt.pointShadowMatrix.value=Y.state.pointShadowMatrix),at.currentProgram=Zt,at.uniformsList=null,Zt}function Ci(b){if(b.uniformsList===null){const W=b.currentProgram.getUniforms();b.uniformsList=yc.seqWithValue(W.seq,b.uniforms)}return b.uniformsList}function wi(b,W){const it=jt.get(b);it.outputColorSpace=W.outputColorSpace,it.batching=W.batching,it.batchingColor=W.batchingColor,it.instancing=W.instancing,it.instancingColor=W.instancingColor,it.instancingMorph=W.instancingMorph,it.skinning=W.skinning,it.morphTargets=W.morphTargets,it.morphNormals=W.morphNormals,it.morphColors=W.morphColors,it.morphTargetsCount=W.morphTargetsCount,it.numClippingPlanes=W.numClippingPlanes,it.numIntersection=W.numClipIntersection,it.vertexAlphas=W.vertexAlphas,it.vertexTangents=W.vertexTangents,it.toneMapping=W.toneMapping}function Xa(b,W,it,at,Y){W.isScene!==!0&&(W=Ue),ae.resetTextureUnits();const Tt=W.fog,Dt=at.isMeshStandardMaterial?W.environment:null,Ot=j===null?w.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:Ms,It=(at.isMeshStandardMaterial?L:Ke).get(at.envMap||Dt),$t=at.vertexColors===!0&&!!it.attributes.color&&it.attributes.color.itemSize===4,Zt=!!it.attributes.tangent&&(!!at.normalMap||at.anisotropy>0),Xt=!!it.morphAttributes.position,ce=!!it.morphAttributes.normal,Ae=!!it.morphAttributes.color;let Ge=Fa;at.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(Ge=w.toneMapping);const _e=it.morphAttributes.position||it.morphAttributes.normal||it.morphAttributes.color,ve=_e!==void 0?_e.length:0,Kt=jt.get(at),Ye=_.state.lights;if(pt===!0&&(yt===!0||b!==R)){const dn=b===R&&at.id===D;Gt.setState(at,b,dn)}let Me=!1;at.version===Kt.__version?(Kt.needsLights&&Kt.lightsStateVersion!==Ye.state.version||Kt.outputColorSpace!==Ot||Y.isBatchedMesh&&Kt.batching===!1||!Y.isBatchedMesh&&Kt.batching===!0||Y.isBatchedMesh&&Kt.batchingColor===!0&&Y.colorTexture===null||Y.isBatchedMesh&&Kt.batchingColor===!1&&Y.colorTexture!==null||Y.isInstancedMesh&&Kt.instancing===!1||!Y.isInstancedMesh&&Kt.instancing===!0||Y.isSkinnedMesh&&Kt.skinning===!1||!Y.isSkinnedMesh&&Kt.skinning===!0||Y.isInstancedMesh&&Kt.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&Kt.instancingColor===!1&&Y.instanceColor!==null||Y.isInstancedMesh&&Kt.instancingMorph===!0&&Y.morphTexture===null||Y.isInstancedMesh&&Kt.instancingMorph===!1&&Y.morphTexture!==null||Kt.envMap!==It||at.fog===!0&&Kt.fog!==Tt||Kt.numClippingPlanes!==void 0&&(Kt.numClippingPlanes!==Gt.numPlanes||Kt.numIntersection!==Gt.numIntersection)||Kt.vertexAlphas!==$t||Kt.vertexTangents!==Zt||Kt.morphTargets!==Xt||Kt.morphNormals!==ce||Kt.morphColors!==Ae||Kt.toneMapping!==Ge||Kt.morphTargetsCount!==ve)&&(Me=!0):(Me=!0,Kt.__version=at.version);let bn=Kt.currentProgram;Me===!0&&(bn=sa(at,W,Y));let la=!1,Ve=!1,Ui=!1;const Ie=bn.getUniforms(),An=Kt.uniforms;if(Vt.useProgram(bn.program)&&(la=!0,Ve=!0,Ui=!0),at.id!==D&&(D=at.id,Ve=!0),la||R!==b){Vt.buffers.depth.getReversed()?(Rt.copy(b.projectionMatrix),xy(Rt),Sy(Rt),Ie.setValue(z,"projectionMatrix",Rt)):Ie.setValue(z,"projectionMatrix",b.projectionMatrix),Ie.setValue(z,"viewMatrix",b.matrixWorldInverse);const yn=Ie.map.cameraPosition;yn!==void 0&&yn.setValue(z,oe.setFromMatrixPosition(b.matrixWorld)),he.logarithmicDepthBuffer&&Ie.setValue(z,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(at.isMeshPhongMaterial||at.isMeshToonMaterial||at.isMeshLambertMaterial||at.isMeshBasicMaterial||at.isMeshStandardMaterial||at.isShaderMaterial)&&Ie.setValue(z,"isOrthographic",b.isOrthographicCamera===!0),R!==b&&(R=b,Ve=!0,Ui=!0)}if(Y.isSkinnedMesh){Ie.setOptional(z,Y,"bindMatrix"),Ie.setOptional(z,Y,"bindMatrixInverse");const dn=Y.skeleton;dn&&(dn.boneTexture===null&&dn.computeBoneTexture(),Ie.setValue(z,"boneTexture",dn.boneTexture,ae))}Y.isBatchedMesh&&(Ie.setOptional(z,Y,"batchingTexture"),Ie.setValue(z,"batchingTexture",Y._matricesTexture,ae),Ie.setOptional(z,Y,"batchingIdTexture"),Ie.setValue(z,"batchingIdTexture",Y._indirectTexture,ae),Ie.setOptional(z,Y,"batchingColorTexture"),Y._colorsTexture!==null&&Ie.setValue(z,"batchingColorTexture",Y._colorsTexture,ae));const on=it.morphAttributes;if((on.position!==void 0||on.normal!==void 0||on.color!==void 0)&&Bt.update(Y,it,bn),(Ve||Kt.receiveShadow!==Y.receiveShadow)&&(Kt.receiveShadow=Y.receiveShadow,Ie.setValue(z,"receiveShadow",Y.receiveShadow)),at.isMeshGouraudMaterial&&at.envMap!==null&&(An.envMap.value=It,An.flipEnvMap.value=It.isCubeTexture&&It.isRenderTargetTexture===!1?-1:1),at.isMeshStandardMaterial&&at.envMap===null&&W.environment!==null&&(An.envMapIntensity.value=W.environmentIntensity),Ve&&(Ie.setValue(z,"toneMappingExposure",w.toneMappingExposure),Kt.needsLights&&oa(An,Ui),Tt&&at.fog===!0&&ot.refreshFogUniforms(An,Tt),ot.refreshMaterialUniforms(An,at,q,$,_.state.transmissionRenderTarget[b.id]),yc.upload(z,Ci(Kt),An,ae)),at.isShaderMaterial&&at.uniformsNeedUpdate===!0&&(yc.upload(z,Ci(Kt),An,ae),at.uniformsNeedUpdate=!1),at.isSpriteMaterial&&Ie.setValue(z,"center",Y.center),Ie.setValue(z,"modelViewMatrix",Y.modelViewMatrix),Ie.setValue(z,"normalMatrix",Y.normalMatrix),Ie.setValue(z,"modelMatrix",Y.matrixWorld),at.isShaderMaterial||at.isRawShaderMaterial){const dn=at.uniformsGroups;for(let yn=0,_i=dn.length;yn<_i;yn++){const Li=dn[yn];G.update(Li,bn),G.bind(Li,bn)}}return bn}function oa(b,W){b.ambientLightColor.needsUpdate=W,b.lightProbe.needsUpdate=W,b.directionalLights.needsUpdate=W,b.directionalLightShadows.needsUpdate=W,b.pointLights.needsUpdate=W,b.pointLightShadows.needsUpdate=W,b.spotLights.needsUpdate=W,b.spotLightShadows.needsUpdate=W,b.rectAreaLights.needsUpdate=W,b.hemisphereLights.needsUpdate=W}function tn(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return I},this.getActiveMipmapLevel=function(){return H},this.getRenderTarget=function(){return j},this.setRenderTargetTextures=function(b,W,it){const at=jt.get(b);at.__autoAllocateDepthBuffer=b.resolveDepthBuffer===!1,at.__autoAllocateDepthBuffer===!1&&(at.__useRenderToTexture=!1),jt.get(b.texture).__webglTexture=W,jt.get(b.depthTexture).__webglTexture=at.__autoAllocateDepthBuffer?void 0:it,at.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(b,W){const it=jt.get(b);it.__webglFramebuffer=W,it.__useDefaultFramebuffer=W===void 0};const Ho=z.createFramebuffer();this.setRenderTarget=function(b,W=0,it=0){j=b,I=W,H=it;let at=!0,Y=null,Tt=!1,Dt=!1;if(b){const It=jt.get(b);if(It.__useDefaultFramebuffer!==void 0)Vt.bindFramebuffer(z.FRAMEBUFFER,null),at=!1;else if(It.__webglFramebuffer===void 0)ae.setupRenderTarget(b);else if(It.__hasExternalTextures)ae.rebindTextures(b,jt.get(b.texture).__webglTexture,jt.get(b.depthTexture).__webglTexture);else if(b.depthBuffer){const Xt=b.depthTexture;if(It.__boundDepthTexture!==Xt){if(Xt!==null&&jt.has(Xt)&&(b.width!==Xt.image.width||b.height!==Xt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");ae.setupDepthRenderbuffer(b)}}const $t=b.texture;($t.isData3DTexture||$t.isDataArrayTexture||$t.isCompressedArrayTexture)&&(Dt=!0);const Zt=jt.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Zt[W])?Y=Zt[W][it]:Y=Zt[W],Tt=!0):b.samples>0&&ae.useMultisampledRTT(b)===!1?Y=jt.get(b).__webglMultisampledFramebuffer:Array.isArray(Zt)?Y=Zt[it]:Y=Zt,k.copy(b.viewport),lt.copy(b.scissor),st=b.scissorTest}else k.copy(J).multiplyScalar(q).floor(),lt.copy(vt).multiplyScalar(q).floor(),st=St;if(it!==0&&(Y=Ho),Vt.bindFramebuffer(z.FRAMEBUFFER,Y)&&at&&Vt.drawBuffers(b,Y),Vt.viewport(k),Vt.scissor(lt),Vt.setScissorTest(st),Tt){const It=jt.get(b.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_CUBE_MAP_POSITIVE_X+W,It.__webglTexture,it)}else if(Dt){const It=jt.get(b.texture),$t=W;z.framebufferTextureLayer(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,It.__webglTexture,it,$t)}else if(b!==null&&it!==0){const It=jt.get(b.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,It.__webglTexture,it)}D=-1},this.readRenderTargetPixels=function(b,W,it,at,Y,Tt,Dt,Ot=0){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let It=jt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Dt!==void 0&&(It=It[Dt]),It){Vt.bindFramebuffer(z.FRAMEBUFFER,It);try{const $t=b.textures[Ot],Zt=$t.format,Xt=$t.type;if(!he.textureFormatReadable(Zt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!he.textureTypeReadable(Xt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}W>=0&&W<=b.width-at&&it>=0&&it<=b.height-Y&&(b.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+Ot),z.readPixels(W,it,at,Y,Ct.convert(Zt),Ct.convert(Xt),Tt))}finally{const $t=j!==null?jt.get(j).__webglFramebuffer:null;Vt.bindFramebuffer(z.FRAMEBUFFER,$t)}}},this.readRenderTargetPixelsAsync=async function(b,W,it,at,Y,Tt,Dt,Ot=0){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let It=jt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Dt!==void 0&&(It=It[Dt]),It)if(W>=0&&W<=b.width-at&&it>=0&&it<=b.height-Y){Vt.bindFramebuffer(z.FRAMEBUFFER,It);const $t=b.textures[Ot],Zt=$t.format,Xt=$t.type;if(!he.textureFormatReadable(Zt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!he.textureTypeReadable(Xt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ce=z.createBuffer();z.bindBuffer(z.PIXEL_PACK_BUFFER,ce),z.bufferData(z.PIXEL_PACK_BUFFER,Tt.byteLength,z.STREAM_READ),b.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+Ot),z.readPixels(W,it,at,Y,Ct.convert(Zt),Ct.convert(Xt),0);const Ae=j!==null?jt.get(j).__webglFramebuffer:null;Vt.bindFramebuffer(z.FRAMEBUFFER,Ae);const Ge=z.fenceSync(z.SYNC_GPU_COMMANDS_COMPLETE,0);return z.flush(),await vy(z,Ge,4),z.bindBuffer(z.PIXEL_PACK_BUFFER,ce),z.getBufferSubData(z.PIXEL_PACK_BUFFER,0,Tt),z.deleteBuffer(ce),z.deleteSync(Ge),Tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(b,W=null,it=0){const at=Math.pow(2,-it),Y=Math.floor(b.image.width*at),Tt=Math.floor(b.image.height*at),Dt=W!==null?W.x:0,Ot=W!==null?W.y:0;ae.setTexture2D(b,0),z.copyTexSubImage2D(z.TEXTURE_2D,it,0,0,Dt,Ot,Y,Tt),Vt.unbindTexture()};const Go=z.createFramebuffer(),Di=z.createFramebuffer();this.copyTextureToTexture=function(b,W,it=null,at=null,Y=0,Tt=null){Tt===null&&(Y!==0?(_s("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Tt=Y,Y=0):Tt=0);let Dt,Ot,It,$t,Zt,Xt,ce,Ae,Ge;const _e=b.isCompressedTexture?b.mipmaps[Tt]:b.image;if(it!==null)Dt=it.max.x-it.min.x,Ot=it.max.y-it.min.y,It=it.isBox3?it.max.z-it.min.z:1,$t=it.min.x,Zt=it.min.y,Xt=it.isBox3?it.min.z:0;else{const on=Math.pow(2,-Y);Dt=Math.floor(_e.width*on),Ot=Math.floor(_e.height*on),b.isDataArrayTexture?It=_e.depth:b.isData3DTexture?It=Math.floor(_e.depth*on):It=1,$t=0,Zt=0,Xt=0}at!==null?(ce=at.x,Ae=at.y,Ge=at.z):(ce=0,Ae=0,Ge=0);const ve=Ct.convert(W.format),Kt=Ct.convert(W.type);let Ye;W.isData3DTexture?(ae.setTexture3D(W,0),Ye=z.TEXTURE_3D):W.isDataArrayTexture||W.isCompressedArrayTexture?(ae.setTexture2DArray(W,0),Ye=z.TEXTURE_2D_ARRAY):(ae.setTexture2D(W,0),Ye=z.TEXTURE_2D),z.pixelStorei(z.UNPACK_FLIP_Y_WEBGL,W.flipY),z.pixelStorei(z.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),z.pixelStorei(z.UNPACK_ALIGNMENT,W.unpackAlignment);const Me=z.getParameter(z.UNPACK_ROW_LENGTH),bn=z.getParameter(z.UNPACK_IMAGE_HEIGHT),la=z.getParameter(z.UNPACK_SKIP_PIXELS),Ve=z.getParameter(z.UNPACK_SKIP_ROWS),Ui=z.getParameter(z.UNPACK_SKIP_IMAGES);z.pixelStorei(z.UNPACK_ROW_LENGTH,_e.width),z.pixelStorei(z.UNPACK_IMAGE_HEIGHT,_e.height),z.pixelStorei(z.UNPACK_SKIP_PIXELS,$t),z.pixelStorei(z.UNPACK_SKIP_ROWS,Zt),z.pixelStorei(z.UNPACK_SKIP_IMAGES,Xt);const Ie=b.isDataArrayTexture||b.isData3DTexture,An=W.isDataArrayTexture||W.isData3DTexture;if(b.isDepthTexture){const on=jt.get(b),dn=jt.get(W),yn=jt.get(on.__renderTarget),_i=jt.get(dn.__renderTarget);Vt.bindFramebuffer(z.READ_FRAMEBUFFER,yn.__webglFramebuffer),Vt.bindFramebuffer(z.DRAW_FRAMEBUFFER,_i.__webglFramebuffer);for(let Li=0;Li<It;Li++)Ie&&(z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,jt.get(b).__webglTexture,Y,Xt+Li),z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,jt.get(W).__webglTexture,Tt,Ge+Li)),z.blitFramebuffer($t,Zt,Dt,Ot,ce,Ae,Dt,Ot,z.DEPTH_BUFFER_BIT,z.NEAREST);Vt.bindFramebuffer(z.READ_FRAMEBUFFER,null),Vt.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else if(Y!==0||b.isRenderTargetTexture||jt.has(b)){const on=jt.get(b),dn=jt.get(W);Vt.bindFramebuffer(z.READ_FRAMEBUFFER,Go),Vt.bindFramebuffer(z.DRAW_FRAMEBUFFER,Di);for(let yn=0;yn<It;yn++)Ie?z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,on.__webglTexture,Y,Xt+yn):z.framebufferTexture2D(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,on.__webglTexture,Y),An?z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,dn.__webglTexture,Tt,Ge+yn):z.framebufferTexture2D(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,dn.__webglTexture,Tt),Y!==0?z.blitFramebuffer($t,Zt,Dt,Ot,ce,Ae,Dt,Ot,z.COLOR_BUFFER_BIT,z.NEAREST):An?z.copyTexSubImage3D(Ye,Tt,ce,Ae,Ge+yn,$t,Zt,Dt,Ot):z.copyTexSubImage2D(Ye,Tt,ce,Ae,$t,Zt,Dt,Ot);Vt.bindFramebuffer(z.READ_FRAMEBUFFER,null),Vt.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else An?b.isDataTexture||b.isData3DTexture?z.texSubImage3D(Ye,Tt,ce,Ae,Ge,Dt,Ot,It,ve,Kt,_e.data):W.isCompressedArrayTexture?z.compressedTexSubImage3D(Ye,Tt,ce,Ae,Ge,Dt,Ot,It,ve,_e.data):z.texSubImage3D(Ye,Tt,ce,Ae,Ge,Dt,Ot,It,ve,Kt,_e):b.isDataTexture?z.texSubImage2D(z.TEXTURE_2D,Tt,ce,Ae,Dt,Ot,ve,Kt,_e.data):b.isCompressedTexture?z.compressedTexSubImage2D(z.TEXTURE_2D,Tt,ce,Ae,_e.width,_e.height,ve,_e.data):z.texSubImage2D(z.TEXTURE_2D,Tt,ce,Ae,Dt,Ot,ve,Kt,_e);z.pixelStorei(z.UNPACK_ROW_LENGTH,Me),z.pixelStorei(z.UNPACK_IMAGE_HEIGHT,bn),z.pixelStorei(z.UNPACK_SKIP_PIXELS,la),z.pixelStorei(z.UNPACK_SKIP_ROWS,Ve),z.pixelStorei(z.UNPACK_SKIP_IMAGES,Ui),Tt===0&&W.generateMipmaps&&z.generateMipmap(Ye),Vt.unbindTexture()},this.copyTextureToTexture3D=function(b,W,it=null,at=null,Y=0){return _s('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(b,W,it,at,Y)},this.initRenderTarget=function(b){jt.get(b).__webglFramebuffer===void 0&&ae.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?ae.setTextureCube(b,0):b.isData3DTexture?ae.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?ae.setTexture2DArray(b,0):ae.setTexture2D(b,0),Vt.unbindTexture()},this.resetState=function(){I=0,H=0,j=null,Vt.reset(),ie.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ea}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=be._getDrawingBufferColorSpace(e),i.unpackColorSpace=be._getUnpackColorSpace()}}function BA({imageSrc:s,title:e,description:i,link:r,delay:l}){return bt.jsxs("div",{className:"bg-gray-900 p-8 rounded-2xl shadow-xl border-l-4 border-blue-500 flex flex-col animate-fade-in-up-stagger card-3d-hover group",style:{animationDelay:l},children:[bt.jsx("div",{className:"mb-4 overflow-hidden rounded-lg",children:bt.jsx("img",{src:s,alt:e,className:"w-full h-40 object-cover rounded-lg project-image-animate",onError:u=>{u.target.onerror=null,u.target.src="https://placehold.co/400x220/374151/FFFFFF?text=Image+Error"}})}),bt.jsx("h3",{className:"text-2xl font-bold text-lime-400 mb-4",children:e}),bt.jsx("p",{className:"text-gray-300 mb-6 flex-grow",children:i}),bt.jsxs("a",{href:r,target:"_blank",rel:"noopener noreferrer",className:"inline-block justify-center bg-gradient-to-r from-lime-500 to-green-600 text-white font-semibold py-3 px-6 rounded-full hover:shadow-lg hover:scale-105 transition duration-300 text-base self-center flex items-center space-x-2",children:[bt.jsx("span",{children:"Visit Website"})," ➡️"]})]})}/**
